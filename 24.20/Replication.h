...
public:
	...
	static void Init() 
	{
		GetViewTarget = Sarah::Offsets::ImageBase + 0xf094dc; 
		CallPreReplication = Sarah::Offsets::ImageBase + 0x7cf1a90; 
		SendClientAdjustment = Sarah::Offsets::ImageBase + 0x7dd856c; 
		CreateChannelByName = Sarah::Offsets::ImageBase + 0x1095e20; 
		SetChannelActor = Sarah::Offsets::ImageBase + 0x55d8688; 
		ReplicateActor = Sarah::Offsets::ImageBase + 0x7e3e934; 
		RemoveNetworkActor = Sarah::Offsets::ImageBase + 0x117906c; 
		ClientHasInitializedLevelFor = Sarah::Offsets::ImageBase + 0x7fbb170; 
		FindActorChannelRef = Sarah::Offsets::ImageBase + 0x6dd3838; 
		CloseActorChannel = Sarah::Offsets::ImageBase + 0x7e3190c; 
		StartBecomingDormant = Sarah::Offsets::ImageBase + 0x7e41fb8; 
		SupportsObject = Sarah::Offsets::ImageBase + 0xfc76a0; 
		GetArchetype = Sarah::Offsets::ImageBase + 0xdacc40; 
		IsNetReady = Sarah::Offsets::ImageBase + 0x7fc3f04; 
		CloseConnection = Sarah::Offsets::ImageBase + 0x17fb490;
		SendDestructionInfo = Sarah::Offsets::ImageBase + 0x7fcb518; 
	}
};
