...
static_assert(sizeof(OptimusNode_GetNodeCategory) == 0x000004, "Wrong size on OptimusNode_GetNodeCategory");
...
static_assert(sizeof(OptimusNode_GetNodeName) == 0x000004, "Wrong size on OptimusNode_GetNodeName");
...
static_assert(sizeof(OptimusDeformerInstance_EnqueueTriggerGraph) == 0x000008, "Wrong size on OptimusDeformerInstance_EnqueueTriggerGraph");
...
static_assert(offsetof(OptimusDeformerInstance_EnqueueTriggerGraph, ReturnValue) == 0x000004, "Member 'OptimusDeformerInstance_EnqueueTriggerGraph::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(OptimusDeformerInstance_SetBoolVariable) == 0x000008, "Wrong size on OptimusDeformerInstance_SetBoolVariable");
...
static_assert(offsetof(OptimusDeformerInstance_SetBoolVariable, InValue) == 0x000004, "Member 'OptimusDeformerInstance_SetBoolVariable::InValue' has a wrong offset!");
static_assert(offsetof(OptimusDeformerInstance_SetBoolVariable, ReturnValue) == 0x000005, "Member 'OptimusDeformerInstance_SetBoolVariable::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(OptimusDeformerInstance_SetIntVariable) == 0x00000C, "Wrong size on OptimusDeformerInstance_SetIntVariable");
...
static_assert(offsetof(OptimusDeformerInstance_SetIntVariable, InValue) == 0x000004, "Member 'OptimusDeformerInstance_SetIntVariable::InValue' has a wrong offset!");
static_assert(offsetof(OptimusDeformerInstance_SetIntVariable, ReturnValue) == 0x000008, "Member 'OptimusDeformerInstance_SetIntVariable::ReturnValue' has a wrong offset!");
