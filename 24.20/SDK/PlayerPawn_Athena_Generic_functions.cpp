...
void APlayerPawn_Athena_Generic_C::K2_OnBecomeViewTarget(class APlayerController* PC)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PlayerPawn_Athena_Generic_C", "K2_OnBecomeViewTarget");

	Params::PlayerPawn_Athena_Generic_C_K2_OnBecomeViewTarget Parms{};
...
void APlayerPawn_Athena_Generic_C::K2_OnEndViewTarget(class APlayerController* PC)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PlayerPawn_Athena_Generic_C", "K2_OnEndViewTarget");

	Params::PlayerPawn_Athena_Generic_C_K2_OnEndViewTarget Parms{};
...
void APlayerPawn_Athena_Generic_C::PawnUniqueIDSet()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PlayerPawn_Athena_Generic_C", "PawnUniqueIDSet");
...
void APlayerPawn_Athena_Generic_C::UpdateViewTargetAudioParameters()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PlayerPawn_Athena_Generic_C", "UpdateViewTargetAudioParameters");
...
void APlayerPawn_Athena_Generic_C::GetActorSoundParams(TArray<struct FAudioParameter>* Params_0) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PlayerPawn_Athena_Generic_C", "GetActorSoundParams");

	Params::PlayerPawn_Athena_Generic_C_GetActorSoundParams Parms{};
