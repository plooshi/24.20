...
static_assert(sizeof(UMovieSceneScriptingActorReferenceKey) == 0x000058, "Wrong size on UMovieSceneScriptingActorReferenceKey");
...
static_assert(sizeof(UMovieSceneScriptingActorReferenceChannel) == 0x000058, "Wrong size on UMovieSceneScriptingActorReferenceChannel");
...
static_assert(sizeof(UMovieSceneScriptingBoolKey) == 0x000058, "Wrong size on UMovieSceneScriptingBoolKey");
...
static_assert(sizeof(UMovieSceneScriptingBoolChannel) == 0x000058, "Wrong size on UMovieSceneScriptingBoolChannel");
...
static_assert(sizeof(UMovieSceneScriptingByteKey) == 0x000058, "Wrong size on UMovieSceneScriptingByteKey");
...
static_assert(sizeof(UMovieSceneScriptingByteChannel) == 0x000058, "Wrong size on UMovieSceneScriptingByteChannel");
...
static_assert(sizeof(UMovieSceneScriptingDoubleKey) == 0x000058, "Wrong size on UMovieSceneScriptingDoubleKey");
...
static_assert(sizeof(UMovieSceneScriptingDoubleChannel) == 0x000058, "Wrong size on UMovieSceneScriptingDoubleChannel");
...
static_assert(sizeof(UMovieSceneScriptingEventKey) == 0x000058, "Wrong size on UMovieSceneScriptingEventKey");
...
static_assert(sizeof(UMovieSceneScriptingEventChannel) == 0x000058, "Wrong size on UMovieSceneScriptingEventChannel");
...
static_assert(sizeof(UMovieSceneScriptingActualFloatKey) == 0x000058, "Wrong size on UMovieSceneScriptingActualFloatKey");
...
static_assert(sizeof(UMovieSceneScriptingDoubleAsFloatKey) == 0x000058, "Wrong size on UMovieSceneScriptingDoubleAsFloatKey");
...
static_assert(sizeof(UMovieSceneScriptingFloatChannel) == 0x000070, "Wrong size on UMovieSceneScriptingFloatChannel");
...
static_assert(sizeof(UMovieSceneScriptingIntegerKey) == 0x000058, "Wrong size on UMovieSceneScriptingIntegerKey");
...
static_assert(sizeof(UMovieSceneScriptingIntegerChannel) == 0x000058, "Wrong size on UMovieSceneScriptingIntegerChannel");
...
static_assert(sizeof(UMovieSceneScriptingObjectPathKey) == 0x000058, "Wrong size on UMovieSceneScriptingObjectPathKey");
...
static_assert(sizeof(UMovieSceneScriptingObjectPathChannel) == 0x000058, "Wrong size on UMovieSceneScriptingObjectPathChannel");
...
static_assert(sizeof(UMovieSceneScriptingStringKey) == 0x000058, "Wrong size on UMovieSceneScriptingStringKey");
...
static_assert(sizeof(UMovieSceneScriptingStringChannel) == 0x000058, "Wrong size on UMovieSceneScriptingStringChannel");
...
public:
	...
	static struct FMovieSceneObjectBindingID MakeBindingID(class UMovieSceneSequence* Sequence, const struct FMovieSceneBindingProxy& InBinding, EMovieSceneObjectBindingSpace Space);
