...
static_assert(sizeof(AARActor) == 0x000288, "Wrong size on AARActor");
...
public:
	...
	TMulticastInlineDelegate<void(struct FTransform& OldToNewTransform)> OnARTransformUpdated;                              // 0x0130(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AAROriginActor) == 0x000288, "Wrong size on AAROriginActor");
...
static_assert(sizeof(AARSharedWorldGameMode) == 0x0003D8, "Wrong size on AARSharedWorldGameMode");
static_assert(offsetof(AARSharedWorldGameMode, BufferSizePerChunk) == 0x000370, "Member 'AARSharedWorldGameMode::BufferSizePerChunk' has a wrong offset!");
...
static_assert(sizeof(AARSharedWorldGameState) == 0x000330, "Wrong size on AARSharedWorldGameState");
static_assert(offsetof(AARSharedWorldGameState, PreviewImageData) == 0x0002F8, "Member 'AARSharedWorldGameState::PreviewImageData' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, ARWorldData) == 0x000308, "Member 'AARSharedWorldGameState::ARWorldData' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, PreviewImageBytesTotal) == 0x000318, "Member 'AARSharedWorldGameState::PreviewImageBytesTotal' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, ARWorldBytesTotal) == 0x00031C, "Member 'AARSharedWorldGameState::ARWorldBytesTotal' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, PreviewImageBytesDelivered) == 0x000320, "Member 'AARSharedWorldGameState::PreviewImageBytesDelivered' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, ARWorldBytesDelivered) == 0x000324, "Member 'AARSharedWorldGameState::ARWorldBytesDelivered' has a wrong offset!");
...
static_assert(sizeof(AARSharedWorldPlayerController) == 0x000850, "Wrong size on AARSharedWorldPlayerController");
...
{
public:
	class UAREnvironmentCaptureProbe*             CaptureProbe;                                      // 0x0298(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AARSkyLight) == 0x0002A8, "Wrong size on AARSkyLight");
static_assert(offsetof(AARSkyLight, CaptureProbe) == 0x000298, "Member 'AARSkyLight::CaptureProbe' has a wrong offset!");
...
public:
	...
	struct FVector2D                              Size;                                              // 0x0158(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UARTexture, TextureType) == 0x000140, "Member 'UARTexture::TextureType' has a wrong offset!");
static_assert(offsetof(UARTexture, Timestamp) == 0x000144, "Member 'UARTexture::Timestamp' has a wrong offset!");
static_assert(offsetof(UARTexture, ExternalTextureGuid) == 0x000148, "Member 'UARTexture::ExternalTextureGuid' has a wrong offset!");
static_assert(offsetof(UARTexture, Size) == 0x000158, "Member 'UARTexture::Size' has a wrong offset!");
...
public:
	...
	struct FVector2D                              Size;                                              // 0x0160(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAREnvironmentCaptureProbeTexture) == 0x000170, "Wrong size on UAREnvironmentCaptureProbeTexture");
