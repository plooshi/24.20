...
static_assert(sizeof(ASimObject) == 0x000290, "Wrong size on ASimObject");
...
public:
	...
	class UActorComponent*                        ActorComponent;                                    // 0x0068(0x0008)(Edit, ExportObject, Net, ZeroConstructor, EditConst, InstancedReference, RepNotify, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	TArray<class UEntityComponent*>               LinkedComponents;                                  // 0x0090(0x0010)(Net, ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
...
{
public:
	struct FUniqueNetIdRepl                       PlayerId;                                          // 0x0068(0x0030)(Net, Transient, RepNotify, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSoftObjectPtr<class APlayerController>       PlayerControllerCache;                             // 0x0098(0x0028)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSoftObjectPtr<class APlayerState>            PlayerStateCache;                                  // 0x00C0(0x0028)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UEntityActorPlayerComponent) == 0x0000E8, "Wrong size on UEntityActorPlayerComponent");
static_assert(offsetof(UEntityActorPlayerComponent, PlayerId) == 0x000068, "Member 'UEntityActorPlayerComponent::PlayerId' has a wrong offset!");
static_assert(offsetof(UEntityActorPlayerComponent, PlayerControllerCache) == 0x000098, "Member 'UEntityActorPlayerComponent::PlayerControllerCache' has a wrong offset!");
static_assert(offsetof(UEntityActorPlayerComponent, PlayerStateCache) == 0x0000C0, "Member 'UEntityActorPlayerComponent::PlayerStateCache' has a wrong offset!");
...
public:
	...
	class USkeletalMesh*                          ShadowVar_SkeletalMesh;                            // 0x0070(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	TArray<class UMaterialInterface*>             ShadowVar_MeshMaterials;                           // 0x0090(0x0010)(Net, ZeroConstructor, RepNotify, UObjectWrapper, NativeAccessSpecifierPrivate)
