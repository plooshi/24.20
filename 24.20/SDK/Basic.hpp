...
namespace Offsets
{
	constexpr int32 GObjects          = 0x105F09D0;
	constexpr int32 AppendString      = 0x00D90944;
	constexpr int32 GNames            = 0x10800400;
	constexpr int32 GWorld            = 0x1078A7D8;
	constexpr int32 ProcessEvent      = 0x00FA4908;
...
namespace BasicFilesImpleUtils
{
	...
	UEAllocatedString GetObjectName(class UClass* Class);
...
public:
	...
	FName(int32 _Ci = 0) : ComparisonIndex(_Ci)
	{
...
static_assert(sizeof(FName) == 0x000004, "Wrong size on FName");
...
public:
	UEType* Get() const
	{
		return (UEType*)InternalGet((FSoftObjectPtr*)this, UClass::StaticClass());
	}
	UEType* operator->() const
	{
		return Get();
...
static_assert(sizeof(FScriptDelegate) == 0x00000C, "Wrong size on FScriptDelegate");
...
static_assert(sizeof(FArrayProperty) == 0x000078, "Wrong size on FArrayProperty");
static_assert(offsetof(FArrayProperty, InnerProperty) == 0x000070, "Member 'FArrayProperty::InnerProperty' has a wrong offset!");
