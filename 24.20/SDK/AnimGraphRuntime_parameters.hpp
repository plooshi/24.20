...
static_assert(offsetof(AnimationStateMachineLibrary_SetState, Duration) == 0x000024, "Member 'AnimationStateMachineLibrary_SetState::Duration' has a wrong offset!");
static_assert(offsetof(AnimationStateMachineLibrary_SetState, BlendType) == 0x000028, "Member 'AnimationStateMachineLibrary_SetState::BlendType' has a wrong offset!");
...
static_assert(offsetof(LayeredBoneBlendLibrary_SetBlendMask, ReturnValue) == 0x000028, "Member 'LayeredBoneBlendLibrary_SetBlendMask::ReturnValue' has a wrong offset!");
