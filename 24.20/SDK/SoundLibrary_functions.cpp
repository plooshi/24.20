...
struct FSoundLibraryPlaySoundResult USoundLibrarySubsystem::PlaySoundSimple(class AActor* OwningActor, const struct FSoundLibrarySimpleContextSettings& InSettings)
{
	static class UFunction* Func = nullptr;
