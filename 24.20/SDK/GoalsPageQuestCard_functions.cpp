...
// (Event, Protected, BlueprintEvent)
// Parameters:
// bool                                    bBattlePassRequired                                    (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// Parameters:
// struct FBundleGoalCardDisplayData       GoalCardDisplayData                                    (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
...
// (Event, Protected, BlueprintEvent)
// Parameters:
// bool                                    bCardIsSelectable                                      (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
