...
static_assert(offsetof(MovieSceneSequence_FindBindingByTag, ReturnValue) == 0x000004, "Member 'MovieSceneSequence_FindBindingByTag::ReturnValue' has a wrong offset!");
