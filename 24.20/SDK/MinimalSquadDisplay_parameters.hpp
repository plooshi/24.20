...
static_assert(sizeof(MinimalSquadDisplay_C_ExecuteUbergraph_MinimalSquadDisplay) == 0x0000F8, "Wrong size on MinimalSquadDisplay_C_ExecuteUbergraph_MinimalSquadDisplay");
...
static_assert(offsetof(MinimalSquadDisplay_C_ExecuteUbergraph_MinimalSquadDisplay, K2Node_CreateDelegate_OutputDelegate_1) == 0x0000E0, "Member 'MinimalSquadDisplay_C_ExecuteUbergraph_MinimalSquadDisplay::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(MinimalSquadDisplay_C_ExecuteUbergraph_MinimalSquadDisplay, CallFunc_GetDynamicMaterial_ReturnValue) == 0x0000F0, "Member 'MinimalSquadDisplay_C_ExecuteUbergraph_MinimalSquadDisplay::CallFunc_GetDynamicMaterial_ReturnValue' has a wrong offset!");
