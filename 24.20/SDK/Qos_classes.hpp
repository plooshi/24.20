...
static_assert(sizeof(AQosBeaconClient) == 0x000350, "Wrong size on AQosBeaconClient");
...
static_assert(sizeof(AQosBeaconHost) == 0x0002B8, "Wrong size on AQosBeaconHost");
