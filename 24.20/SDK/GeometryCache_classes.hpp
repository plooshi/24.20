...
static_assert(sizeof(AGeometryCacheActor) == 0x000290, "Wrong size on AGeometryCacheActor");
static_assert(offsetof(AGeometryCacheActor, GeometryCacheComponent) == 0x000288, "Member 'AGeometryCacheActor::GeometryCacheComponent' has a wrong offset!");
...
static_assert(offsetof(UGeometryCacheComponent, GeometryCache) == 0x0005A0, "Member 'UGeometryCacheComponent::GeometryCache' has a wrong offset!");
static_assert(offsetof(UGeometryCacheComponent, bRunning) == 0x0005A8, "Member 'UGeometryCacheComponent::bRunning' has a wrong offset!");
static_assert(offsetof(UGeometryCacheComponent, bLooping) == 0x0005A9, "Member 'UGeometryCacheComponent::bLooping' has a wrong offset!");
static_assert(offsetof(UGeometryCacheComponent, bExtrapolateFrames) == 0x0005AA, "Member 'UGeometryCacheComponent::bExtrapolateFrames' has a wrong offset!");
static_assert(offsetof(UGeometryCacheComponent, StartTimeOffset) == 0x0005AC, "Member 'UGeometryCacheComponent::StartTimeOffset' has a wrong offset!");
static_assert(offsetof(UGeometryCacheComponent, PlaybackSpeed) == 0x0005B0, "Member 'UGeometryCacheComponent::PlaybackSpeed' has a wrong offset!");
static_assert(offsetof(UGeometryCacheComponent, MotionVectorScale) == 0x0005B4, "Member 'UGeometryCacheComponent::MotionVectorScale' has a wrong offset!");
static_assert(offsetof(UGeometryCacheComponent, numTracks) == 0x0005B8, "Member 'UGeometryCacheComponent::numTracks' has a wrong offset!");
static_assert(offsetof(UGeometryCacheComponent, ElapsedTime) == 0x0005BC, "Member 'UGeometryCacheComponent::ElapsedTime' has a wrong offset!");
static_assert(offsetof(UGeometryCacheComponent, Duration) == 0x00060C, "Member 'UGeometryCacheComponent::Duration' has a wrong offset!");
static_assert(offsetof(UGeometryCacheComponent, bManualTick) == 0x000610, "Member 'UGeometryCacheComponent::bManualTick' has a wrong offset!");
static_assert(offsetof(UGeometryCacheComponent, bOverrideWireframeColor) == 0x000611, "Member 'UGeometryCacheComponent::bOverrideWireframeColor' has a wrong offset!");
static_assert(offsetof(UGeometryCacheComponent, WireframeOverrideColor) == 0x000614, "Member 'UGeometryCacheComponent::WireframeOverrideColor' has a wrong offset!");
...
static_assert(sizeof(UNiagaraGeometryCacheRendererProperties) == 0x0002A8, "Wrong size on UNiagaraGeometryCacheRendererProperties");
static_assert(offsetof(UNiagaraGeometryCacheRendererProperties, GeometryCaches) == 0x0000C8, "Member 'UNiagaraGeometryCacheRendererProperties::GeometryCaches' has a wrong offset!");
static_assert(offsetof(UNiagaraGeometryCacheRendererProperties, bIsLooping) == 0x0000D8, "Member 'UNiagaraGeometryCacheRendererProperties::bIsLooping' has a wrong offset!");
static_assert(offsetof(UNiagaraGeometryCacheRendererProperties, ComponentCountLimit) == 0x0000DC, "Member 'UNiagaraGeometryCacheRendererProperties::ComponentCountLimit' has a wrong offset!");
static_assert(offsetof(UNiagaraGeometryCacheRendererProperties, PositionBinding) == 0x0000E0, "Member 'UNiagaraGeometryCacheRendererProperties::PositionBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraGeometryCacheRendererProperties, RotationBinding) == 0x000120, "Member 'UNiagaraGeometryCacheRendererProperties::RotationBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraGeometryCacheRendererProperties, ScaleBinding) == 0x000160, "Member 'UNiagaraGeometryCacheRendererProperties::ScaleBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraGeometryCacheRendererProperties, ElapsedTimeBinding) == 0x0001A0, "Member 'UNiagaraGeometryCacheRendererProperties::ElapsedTimeBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraGeometryCacheRendererProperties, EnabledBinding) == 0x0001E0, "Member 'UNiagaraGeometryCacheRendererProperties::EnabledBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraGeometryCacheRendererProperties, ArrayIndexBinding) == 0x000220, "Member 'UNiagaraGeometryCacheRendererProperties::ArrayIndexBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraGeometryCacheRendererProperties, RendererVisibilityTagBinding) == 0x000260, "Member 'UNiagaraGeometryCacheRendererProperties::RendererVisibilityTagBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraGeometryCacheRendererProperties, RendererVisibility) == 0x0002A0, "Member 'UNiagaraGeometryCacheRendererProperties::RendererVisibility' has a wrong offset!");
static_assert(offsetof(UNiagaraGeometryCacheRendererProperties, bAssignComponentsOnParticleID) == 0x0002A4, "Member 'UNiagaraGeometryCacheRendererProperties::bAssignComponentsOnParticleID' has a wrong offset!");
