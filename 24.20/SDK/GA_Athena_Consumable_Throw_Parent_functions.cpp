...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class AFortProjectileBase*              SpawnedProjectile_0                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
// double                                  ProjectileGravityScale_0                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class AFortProjectileBase*              SpawnedProjectile_0                                    (Parm, OutParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void UGA_Athena_Consumable_Throw_Parent_C::GetProjectileAdditionalThrowAngleToUse(double* AdditionalThrowAngleToUse) const
{
	static class UFunction* Func = nullptr;
