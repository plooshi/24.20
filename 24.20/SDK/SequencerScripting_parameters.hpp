...
static_assert(offsetof(MovieSceneFolderExtensions_SetFolderName, ReturnValue) == 0x00000C, "Member 'MovieSceneFolderExtensions_SetFolderName::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(MovieSceneSequenceExtensions_MakeBindingID, Sequence) == 0x000000, "Member 'MovieSceneSequenceExtensions_MakeBindingID::Sequence' has a wrong offset!");
