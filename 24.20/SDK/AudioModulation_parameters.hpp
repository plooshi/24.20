...
{
public:
	struct FSoundModulationDestinationSettings    Destination;                                       // 0x0000(0x0060)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	TSet<class USoundModulatorBase*>              ReturnValue;                                       // 0x0060(0x0050)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(AudioModulationStatics_GetModulatorsFromDestination) == 0x0000B0, "Wrong size on AudioModulationStatics_GetModulatorsFromDestination");
...
static_assert(offsetof(AudioModulationStatics_GetModulatorsFromDestination, ReturnValue) == 0x000060, "Member 'AudioModulationStatics_GetModulatorsFromDestination::ReturnValue' has a wrong offset!");
