...
static_assert(sizeof(FExpeditionTabInfo) == 0x000100, "Wrong size on FExpeditionTabInfo");
...
{
public:
	class UFortItem*                              RewardItem;                                        // 0x0000(0x0008)(BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	class UMediaSource*                           PreviewVideoMediaSource;                           // 0x0088(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
