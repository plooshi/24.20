...
static_assert(offsetof(ConversationNode_GetDebugParticipantColor, ReturnValue) == 0x000004, "Member 'ConversationNode_GetDebugParticipantColor::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(ConversationParticipantComponent_ClientStartConversation) == 0x000004, "Wrong size on ConversationParticipantComponent_ClientStartConversation");
