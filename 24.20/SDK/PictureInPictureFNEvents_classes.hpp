...
static_assert(sizeof(ULiveEventHUDAd) == 0x000268, "Wrong size on ULiveEventHUDAd");
...
{
public:
	class UPictureInPictureFNEventsClient*        FNEventsClient;                                    // 0x0558(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class ULiveEventHUDAd*                        HUDAdvertWidget;                                   // 0x0560(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
