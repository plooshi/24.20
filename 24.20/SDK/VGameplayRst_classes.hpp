...
{
public:
	class UVerseAssetPtr*                         SoundAsset;                                        // 0x0090(0x0008)(Net, ZeroConstructor, RepNotify, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	struct FDatastoreState                        ReplicatedDatastoreState;                          // 0x00E8(0x0128)(Net, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UDatastoreComponentBase) == 0x000228, "Wrong size on UDatastoreComponentBase");
static_assert(offsetof(UDatastoreComponentBase, ReplicatedDatastoreState) == 0x0000E8, "Member 'UDatastoreComponentBase::ReplicatedDatastoreState' has a wrong offset!");
...
{
public:
	class UVerseLightPropertiesBase*              ReplicatedLightProperties;                         // 0x0090(0x0008)(Net, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	class UVerseAssetPtr*                         ParticleSystemAsset;                               // 0x0090(0x0008)(Net, ZeroConstructor, RepNotify, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
