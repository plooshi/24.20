...
// (Event, Protected, BlueprintEvent)
// Parameters:
// class UCommonButtonLegacy*              Button                                                 (Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// EFilterType                             FilterType                                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UAthenaGiftingScreen::OnSetupFilterTabButton(class UCommonButtonLegacy* Button, EFilterType FilterType)
{
	static class UFunction* Func = nullptr;
