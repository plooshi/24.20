...
void AFortAthenaMutator_SpecialEvent::OnGamePhaseChanged(EAthenaGamePhase NewPhase)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortAthenaMutator_SpecialEvent", "OnGamePhaseChanged");

	Params::FortAthenaMutator_SpecialEvent_OnGamePhaseChanged Parms{};
