...
public:
	...
	TArray<class UAudioComponent*>                AudioComponents;                                   // 0x0018(0x0010)(BlueprintVisible, ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPublic)
};
