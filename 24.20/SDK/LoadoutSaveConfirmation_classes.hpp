...
static_assert(sizeof(ULoadoutSaveConfirmation_C) == 0x0005D8, "Wrong size on ULoadoutSaveConfirmation_C");
static_assert(offsetof(ULoadoutSaveConfirmation_C, UberGraphFrame) == 0x000568, "Member 'ULoadoutSaveConfirmation_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ULoadoutSaveConfirmation_C, Image_66) == 0x000570, "Member 'ULoadoutSaveConfirmation_C::Image_66' has a wrong offset!");
static_assert(offsetof(ULoadoutSaveConfirmation_C, Image_Separator_Down) == 0x000578, "Member 'ULoadoutSaveConfirmation_C::Image_Separator_Down' has a wrong offset!");
static_assert(offsetof(ULoadoutSaveConfirmation_C, Image_Separator_Up) == 0x000580, "Member 'ULoadoutSaveConfirmation_C::Image_Separator_Up' has a wrong offset!");
static_assert(offsetof(ULoadoutSaveConfirmation_C, Lightbox) == 0x000588, "Member 'ULoadoutSaveConfirmation_C::Lightbox' has a wrong offset!");
static_assert(offsetof(ULoadoutSaveConfirmation_C, SafeZone_145) == 0x000590, "Member 'ULoadoutSaveConfirmation_C::SafeZone_145' has a wrong offset!");
static_assert(offsetof(ULoadoutSaveConfirmation_C, SwitcherExplanation) == 0x000598, "Member 'ULoadoutSaveConfirmation_C::SwitcherExplanation' has a wrong offset!");
static_assert(offsetof(ULoadoutSaveConfirmation_C, SwitcherTitle) == 0x0005A0, "Member 'ULoadoutSaveConfirmation_C::SwitcherTitle' has a wrong offset!");
static_assert(offsetof(ULoadoutSaveConfirmation_C, TextBlockCREATE) == 0x0005A8, "Member 'ULoadoutSaveConfirmation_C::TextBlockCREATE' has a wrong offset!");
static_assert(offsetof(ULoadoutSaveConfirmation_C, TextBlockExplanation) == 0x0005B0, "Member 'ULoadoutSaveConfirmation_C::TextBlockExplanation' has a wrong offset!");
static_assert(offsetof(ULoadoutSaveConfirmation_C, TextBlockExplanation_SaveOnly) == 0x0005B8, "Member 'ULoadoutSaveConfirmation_C::TextBlockExplanation_SaveOnly' has a wrong offset!");
static_assert(offsetof(ULoadoutSaveConfirmation_C, TextBlockOR) == 0x0005C0, "Member 'ULoadoutSaveConfirmation_C::TextBlockOR' has a wrong offset!");
static_assert(offsetof(ULoadoutSaveConfirmation_C, TextBlockTitle) == 0x0005C8, "Member 'ULoadoutSaveConfirmation_C::TextBlockTitle' has a wrong offset!");
static_assert(offsetof(ULoadoutSaveConfirmation_C, TextBlockTitle_SaveOnly) == 0x0005D0, "Member 'ULoadoutSaveConfirmation_C::TextBlockTitle_SaveOnly' has a wrong offset!");
