...
static_assert(sizeof(AchievementBlueprintLibrary_GetCachedAchievementDescription) == 0x000068, "Wrong size on AchievementBlueprintLibrary_GetCachedAchievementDescription");
...
static_assert(offsetof(AchievementBlueprintLibrary_GetCachedAchievementDescription, bFoundID) == 0x000014, "Member 'AchievementBlueprintLibrary_GetCachedAchievementDescription::bFoundID' has a wrong offset!");
static_assert(offsetof(AchievementBlueprintLibrary_GetCachedAchievementDescription, Title) == 0x000018, "Member 'AchievementBlueprintLibrary_GetCachedAchievementDescription::Title' has a wrong offset!");
...
static_assert(offsetof(AchievementBlueprintLibrary_GetCachedAchievementDescription, UnlockedDescription) == 0x000048, "Member 'AchievementBlueprintLibrary_GetCachedAchievementDescription::UnlockedDescription' has a wrong offset!");
static_assert(offsetof(AchievementBlueprintLibrary_GetCachedAchievementDescription, bHidden) == 0x000060, "Member 'AchievementBlueprintLibrary_GetCachedAchievementDescription::bHidden' has a wrong offset!");
...
static_assert(offsetof(AchievementBlueprintLibrary_GetCachedAchievementProgress, bFoundID) == 0x000014, "Member 'AchievementBlueprintLibrary_GetCachedAchievementProgress::bFoundID' has a wrong offset!");
static_assert(offsetof(AchievementBlueprintLibrary_GetCachedAchievementProgress, Progress) == 0x000018, "Member 'AchievementBlueprintLibrary_GetCachedAchievementProgress::Progress' has a wrong offset!");
...
static_assert(offsetof(AchievementWriteCallbackProxy_WriteAchievementProgress, Progress) == 0x000014, "Member 'AchievementWriteCallbackProxy_WriteAchievementProgress::Progress' has a wrong offset!");
static_assert(offsetof(AchievementWriteCallbackProxy_WriteAchievementProgress, UserTag) == 0x000018, "Member 'AchievementWriteCallbackProxy_WriteAchievementProgress::UserTag' has a wrong offset!");
