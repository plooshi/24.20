...
static_assert(sizeof(UGameplayStateMachine) == 0x0000C8, "Wrong size on UGameplayStateMachine");
static_assert(offsetof(UGameplayStateMachine, StateMachineId) == 0x000090, "Member 'UGameplayStateMachine::StateMachineId' has a wrong offset!");
static_assert(offsetof(UGameplayStateMachine, ActiveGameplayStateData) == 0x000098, "Member 'UGameplayStateMachine::ActiveGameplayStateData' has a wrong offset!");
static_assert(offsetof(UGameplayStateMachine, GameplayStateSettings) == 0x0000B0, "Member 'UGameplayStateMachine::GameplayStateSettings' has a wrong offset!");
static_assert(offsetof(UGameplayStateMachine, InitialGameplayStateId) == 0x0000C0, "Member 'UGameplayStateMachine::InitialGameplayStateId' has a wrong offset!");
