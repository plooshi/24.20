...
public:
	...
	struct FRigVMExtendedExecuteContext           Context;                                           // 0x00A8(0x0070)(Transient, Protected, NativeAccessSpecifierProtected)
	uint32                                        NumExecutions;                                     // 0x0118(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	uint8                                         Pad_1C8[0xB8];                                     // 0x01C8(0x00B8)(Fixing Size After Last Property [ Dumper-7 ])
	class URigVM*                                 DeferredVMToCopy;                                  // 0x0280(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(URigVM) == 0x0002A0, "Wrong size on URigVM");
...
static_assert(offsetof(URigVM, NumExecutions) == 0x000118, "Member 'URigVM::NumExecutions' has a wrong offset!");
...
static_assert(offsetof(URigVM, DeferredVMToCopy) == 0x000280, "Member 'URigVM::DeferredVMToCopy' has a wrong offset!");
...
static_assert(sizeof(URigVMNativized) == 0x0002A8, "Wrong size on URigVMNativized");
