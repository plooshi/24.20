...
{
public:
	class UAudioGameplayVolumeComponent*          AGVComponent;                                      // 0x02C0(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bEnabled;                                          // 0x02C8(0x0001)(Edit, BlueprintVisible, Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2C9[0x7];                                      // 0x02C9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TMulticastInlineDelegate<void()>              OnListenerEnterEvent;                              // 0x02D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnListenerExitEvent;                               // 0x02E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AAudioGameplayVolume) == 0x0002F0, "Wrong size on AAudioGameplayVolume");
static_assert(offsetof(AAudioGameplayVolume, AGVComponent) == 0x0002C0, "Member 'AAudioGameplayVolume::AGVComponent' has a wrong offset!");
static_assert(offsetof(AAudioGameplayVolume, bEnabled) == 0x0002C8, "Member 'AAudioGameplayVolume::bEnabled' has a wrong offset!");
static_assert(offsetof(AAudioGameplayVolume, OnListenerEnterEvent) == 0x0002D0, "Member 'AAudioGameplayVolume::OnListenerEnterEvent' has a wrong offset!");
static_assert(offsetof(AAudioGameplayVolume, OnListenerExitEvent) == 0x0002E0, "Member 'AAudioGameplayVolume::OnListenerExitEvent' has a wrong offset!");
