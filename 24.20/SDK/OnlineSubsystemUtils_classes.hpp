...
{
public:
	uint8                                         LogPortUnreach : 1;                                // 0x0798(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         AllowPlayerPortUnreach : 1;                        // 0x0798(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bExitOnBindFailure : 1;                            // 0x0798(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_799[0x3];                                      // 0x0799(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint32                                        MaxPortCountToTry;                                 // 0x079C(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_7A0[0x4];                                      // 0x07A0(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	uint32                                        ServerDesiredSocketReceiveBufferBytes;             // 0x07A4(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint32                                        ServerDesiredSocketSendBufferBytes;                // 0x07A8(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint32                                        ClientDesiredSocketReceiveBufferBytes;             // 0x07AC(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint32                                        ClientDesiredSocketSendBufferBytes;                // 0x07B0(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	uint8                                         Pad_7C8[0x80];                                     // 0x07C8(0x0080)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UIpNetDriver) == 0x000848, "Wrong size on UIpNetDriver");
static_assert(offsetof(UIpNetDriver, MaxPortCountToTry) == 0x00079C, "Member 'UIpNetDriver::MaxPortCountToTry' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ServerDesiredSocketReceiveBufferBytes) == 0x0007A4, "Member 'UIpNetDriver::ServerDesiredSocketReceiveBufferBytes' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ServerDesiredSocketSendBufferBytes) == 0x0007A8, "Member 'UIpNetDriver::ServerDesiredSocketSendBufferBytes' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ClientDesiredSocketReceiveBufferBytes) == 0x0007AC, "Member 'UIpNetDriver::ClientDesiredSocketReceiveBufferBytes' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ClientDesiredSocketSendBufferBytes) == 0x0007B0, "Member 'UIpNetDriver::ClientDesiredSocketSendBufferBytes' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, MaxSecondsInReceive) == 0x0007B8, "Member 'UIpNetDriver::MaxSecondsInReceive' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, NbPacketsBetweenReceiveTimeTest) == 0x0007C0, "Member 'UIpNetDriver::NbPacketsBetweenReceiveTimeTest' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ResolutionConnectionTimeout) == 0x0007C4, "Member 'UIpNetDriver::ResolutionConnectionTimeout' has a wrong offset!");
...
static_assert(sizeof(ULeaderboardQueryCallbackProxy) == 0x000090, "Wrong size on ULeaderboardQueryCallbackProxy");
...
public:
	...
	class UNetDriver*                             NetDriver;                                         // 0x0298(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AOnlineBeacon) == 0x0002B8, "Wrong size on AOnlineBeacon");
static_assert(offsetof(AOnlineBeacon, BeaconConnectionInitialTimeout) == 0x000290, "Member 'AOnlineBeacon::BeaconConnectionInitialTimeout' has a wrong offset!");
static_assert(offsetof(AOnlineBeacon, BeaconConnectionTimeout) == 0x000294, "Member 'AOnlineBeacon::BeaconConnectionTimeout' has a wrong offset!");
static_assert(offsetof(AOnlineBeacon, NetDriver) == 0x000298, "Member 'AOnlineBeacon::NetDriver' has a wrong offset!");
...
{
public:
	class AOnlineBeaconHostObject*                BeaconOwner;                                       // 0x02B8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UNetConnection*                         BeaconConnection;                                  // 0x02C0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(AOnlineBeaconClient, BeaconOwner) == 0x0002B8, "Member 'AOnlineBeaconClient::BeaconOwner' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconClient, BeaconConnection) == 0x0002C0, "Member 'AOnlineBeaconClient::BeaconConnection' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconClient, ConnectionState) == 0x0002C8, "Member 'AOnlineBeaconClient::ConnectionState' has a wrong offset!");
...
public:
	...
	bool                                          bReuseAddressAndPort;                              // 0x02BC(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAuthRequired;                                     // 0x02BD(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AOnlineBeaconHost) == 0x0003C8, "Wrong size on AOnlineBeaconHost");
static_assert(offsetof(AOnlineBeaconHost, ListenPort) == 0x0002B8, "Member 'AOnlineBeaconHost::ListenPort' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHost, bReuseAddressAndPort) == 0x0002BC, "Member 'AOnlineBeaconHost::bReuseAddressAndPort' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHost, bAuthRequired) == 0x0002BD, "Member 'AOnlineBeaconHost::bAuthRequired' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHost, MaxAuthTokenSize) == 0x0002C0, "Member 'AOnlineBeaconHost::MaxAuthTokenSize' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHost, ClientActors) == 0x000318, "Member 'AOnlineBeaconHost::ClientActors' has a wrong offset!");
...
public:
	...
	TSubclassOf<class AOnlineBeaconClient>        ClientBeaconActorClass;                            // 0x0298(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AOnlineBeaconHostObject) == 0x0002B0, "Wrong size on AOnlineBeaconHostObject");
static_assert(offsetof(AOnlineBeaconHostObject, BeaconTypeName) == 0x000288, "Member 'AOnlineBeaconHostObject::BeaconTypeName' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHostObject, ClientBeaconActorClass) == 0x000298, "Member 'AOnlineBeaconHostObject::ClientBeaconActorClass' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHostObject, ClientActors) == 0x0002A0, "Member 'AOnlineBeaconHostObject::ClientActors' has a wrong offset!");
...
static_assert(sizeof(UOnlinePIESettings) == 0x000048, "Wrong size on UOnlinePIESettings");
static_assert(offsetof(UOnlinePIESettings, bOnlinePIEEnabled) == 0x000030, "Member 'UOnlinePIESettings::bOnlinePIEEnabled' has a wrong offset!");
static_assert(offsetof(UOnlinePIESettings, Logins) == 0x000038, "Member 'UOnlinePIESettings::Logins' has a wrong offset!");
...
static_assert(sizeof(APartyBeaconClient) == 0x0003E0, "Wrong size on APartyBeaconClient");
static_assert(offsetof(APartyBeaconClient, DestSessionId) == 0x000348, "Member 'APartyBeaconClient::DestSessionId' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, PendingReservation) == 0x000358, "Member 'APartyBeaconClient::PendingReservation' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, RequestType) == 0x0003B0, "Member 'APartyBeaconClient::RequestType' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, bPendingReservationSent) == 0x0003B1, "Member 'APartyBeaconClient::bPendingReservationSent' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, bCancelReservation) == 0x0003B2, "Member 'APartyBeaconClient::bCancelReservation' has a wrong offset!");
...
{
public:
	class UPartyBeaconState*                      State;                                             // 0x02B0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(APartyBeaconHost) == 0x000328, "Wrong size on APartyBeaconHost");
static_assert(offsetof(APartyBeaconHost, State) == 0x0002B0, "Member 'APartyBeaconHost::State' has a wrong offset!");
static_assert(offsetof(APartyBeaconHost, bLogoutOnSessionTimeout) == 0x000318, "Member 'APartyBeaconHost::bLogoutOnSessionTimeout' has a wrong offset!");
static_assert(offsetof(APartyBeaconHost, SessionTimeoutSecs) == 0x00031C, "Member 'APartyBeaconHost::SessionTimeoutSecs' has a wrong offset!");
static_assert(offsetof(APartyBeaconHost, TravelSessionTimeoutSecs) == 0x000320, "Member 'APartyBeaconHost::TravelSessionTimeoutSecs' has a wrong offset!");
...
static_assert(sizeof(UPartyBeaconState) == 0x000098, "Wrong size on UPartyBeaconState");
static_assert(offsetof(UPartyBeaconState, SessionName) == 0x000028, "Member 'UPartyBeaconState::SessionName' has a wrong offset!");
static_assert(offsetof(UPartyBeaconState, NumConsumedReservations) == 0x00002C, "Member 'UPartyBeaconState::NumConsumedReservations' has a wrong offset!");
static_assert(offsetof(UPartyBeaconState, MaxReservations) == 0x000030, "Member 'UPartyBeaconState::MaxReservations' has a wrong offset!");
static_assert(offsetof(UPartyBeaconState, NumTeams) == 0x000034, "Member 'UPartyBeaconState::NumTeams' has a wrong offset!");
static_assert(offsetof(UPartyBeaconState, NumPlayersPerTeam) == 0x000038, "Member 'UPartyBeaconState::NumPlayersPerTeam' has a wrong offset!");
static_assert(offsetof(UPartyBeaconState, TeamAssignmentMethod) == 0x00003C, "Member 'UPartyBeaconState::TeamAssignmentMethod' has a wrong offset!");
static_assert(offsetof(UPartyBeaconState, ReservedHostTeamNum) == 0x000040, "Member 'UPartyBeaconState::ReservedHostTeamNum' has a wrong offset!");
static_assert(offsetof(UPartyBeaconState, ForceTeamNum) == 0x000044, "Member 'UPartyBeaconState::ForceTeamNum' has a wrong offset!");
static_assert(offsetof(UPartyBeaconState, bRestrictCrossConsole) == 0x000048, "Member 'UPartyBeaconState::bRestrictCrossConsole' has a wrong offset!");
static_assert(offsetof(UPartyBeaconState, PlatformCrossplayRestrictions) == 0x000050, "Member 'UPartyBeaconState::PlatformCrossplayRestrictions' has a wrong offset!");
static_assert(offsetof(UPartyBeaconState, PlatformTypeMapping) == 0x000060, "Member 'UPartyBeaconState::PlatformTypeMapping' has a wrong offset!");
static_assert(offsetof(UPartyBeaconState, bEnableRemovalRequests) == 0x000070, "Member 'UPartyBeaconState::bEnableRemovalRequests' has a wrong offset!");
static_assert(offsetof(UPartyBeaconState, Reservations) == 0x000078, "Member 'UPartyBeaconState::Reservations' has a wrong offset!");
...
static_assert(offsetof(ASpectatorBeaconClient, DestSessionId) == 0x000348, "Member 'ASpectatorBeaconClient::DestSessionId' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconClient, PendingReservation) == 0x000358, "Member 'ASpectatorBeaconClient::PendingReservation' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconClient, RequestType) == 0x0003E0, "Member 'ASpectatorBeaconClient::RequestType' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconClient, bPendingReservationSent) == 0x0003E1, "Member 'ASpectatorBeaconClient::bPendingReservationSent' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconClient, bCancelReservation) == 0x0003E2, "Member 'ASpectatorBeaconClient::bCancelReservation' has a wrong offset!");
...
{
public:
	class USpectatorBeaconState*                  State;                                             // 0x02B0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2B8[0x60];                                     // 0x02B8(0x0060)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bLogoutOnSessionTimeout;                           // 0x0318(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_319[0x3];                                      // 0x0319(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         SessionTimeoutSecs;                                // 0x031C(0x0004)(ZeroConstructor, Transient, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(ASpectatorBeaconHost) == 0x000328, "Wrong size on ASpectatorBeaconHost");
static_assert(offsetof(ASpectatorBeaconHost, State) == 0x0002B0, "Member 'ASpectatorBeaconHost::State' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconHost, bLogoutOnSessionTimeout) == 0x000318, "Member 'ASpectatorBeaconHost::bLogoutOnSessionTimeout' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconHost, SessionTimeoutSecs) == 0x00031C, "Member 'ASpectatorBeaconHost::SessionTimeoutSecs' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconHost, TravelSessionTimeoutSecs) == 0x000320, "Member 'ASpectatorBeaconHost::TravelSessionTimeoutSecs' has a wrong offset!");
...
static_assert(sizeof(USpectatorBeaconState) == 0x000058, "Wrong size on USpectatorBeaconState");
...
static_assert(offsetof(USpectatorBeaconState, NumConsumedReservations) == 0x00002C, "Member 'USpectatorBeaconState::NumConsumedReservations' has a wrong offset!");
static_assert(offsetof(USpectatorBeaconState, MaxReservations) == 0x000030, "Member 'USpectatorBeaconState::MaxReservations' has a wrong offset!");
static_assert(offsetof(USpectatorBeaconState, bRestrictCrossConsole) == 0x000034, "Member 'USpectatorBeaconState::bRestrictCrossConsole' has a wrong offset!");
static_assert(offsetof(USpectatorBeaconState, Reservations) == 0x000038, "Member 'USpectatorBeaconState::Reservations' has a wrong offset!");
...
static_assert(sizeof(ATestBeaconClient) == 0x000318, "Wrong size on ATestBeaconClient");
...
static_assert(sizeof(ATestBeaconHost) == 0x0002B0, "Wrong size on ATestBeaconHost");
...
static_assert(sizeof(UVoipListenerSynthComponent) == 0x000980, "Wrong size on UVoipListenerSynthComponent");
