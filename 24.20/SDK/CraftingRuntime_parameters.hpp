...
static_assert(sizeof(FortControllerComponent_CraftingNetworkEvents_ServerPauseCrafting) == 0x000008, "Wrong size on FortControllerComponent_CraftingNetworkEvents_ServerPauseCrafting");
...
static_assert(sizeof(FortControllerComponent_CraftingNetworkEvents_ServerResumeCrafting) == 0x000008, "Wrong size on FortControllerComponent_CraftingNetworkEvents_ServerResumeCrafting");
...
static_assert(sizeof(CraftingLibrary_PauseCrafting) == 0x000010, "Wrong size on CraftingLibrary_PauseCrafting");
...
static_assert(sizeof(CraftingLibrary_ResumeCrafting) == 0x000010, "Wrong size on CraftingLibrary_ResumeCrafting");
