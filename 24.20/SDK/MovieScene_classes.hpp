...
static_assert(sizeof(UMovieSceneEntitySystemLinker) == 0x0006F8, "Wrong size on UMovieSceneEntitySystemLinker");
...
static_assert(offsetof(UMovieSceneFolder, ChildTracks) == 0x000040, "Member 'UMovieSceneFolder::ChildTracks' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_348[0x90];                                     // 0x0348(0x0090)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneSequenceReplProperties      NetSyncProps;                                      // 0x03D8(0x0010)(Net, NoDestructor, Protected, NativeAccessSpecifierProtected)
	TScriptInterface<class IMovieScenePlaybackClient> PlaybackClient;                                    // 0x03E8(0x0010)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMovieSceneSequenceTickManager*         TickManager;                                       // 0x03F8(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UMovieSceneSequencePlayer, NetSyncProps) == 0x0003D8, "Member 'UMovieSceneSequencePlayer::NetSyncProps' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, PlaybackClient) == 0x0003E8, "Member 'UMovieSceneSequencePlayer::PlaybackClient' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, TickManager) == 0x0003F8, "Member 'UMovieSceneSequencePlayer::TickManager' has a wrong offset!");
