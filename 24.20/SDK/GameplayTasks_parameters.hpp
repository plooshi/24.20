...
static_assert(sizeof(GameplayTask_ClaimResource_ClaimResource) == 0x000028, "Wrong size on GameplayTask_ClaimResource_ClaimResource");
...
static_assert(offsetof(GameplayTask_ClaimResource_ClaimResource, ReturnValue) == 0x000020, "Member 'GameplayTask_ClaimResource_ClaimResource::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(GameplayTask_ClaimResource_ClaimResources) == 0x000030, "Wrong size on GameplayTask_ClaimResource_ClaimResources");
...
static_assert(offsetof(GameplayTask_ClaimResource_ClaimResources, ReturnValue) == 0x000028, "Member 'GameplayTask_ClaimResource_ClaimResources::ReturnValue' has a wrong offset!");
