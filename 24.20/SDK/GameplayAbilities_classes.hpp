...
{
public:
	bool                                          ShouldProduceTargetDataOnServer;                   // 0x0288(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_289[0x7];                                      // 0x0289(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayAbilityTargetingLocationInfo  StartLocation;                                     // 0x0290(0x00A0)(BlueprintVisible, BlueprintReadOnly, Net, ContainsInstancedReference, ExposeOnSpawn, NativeAccessSpecifierPublic)
	uint8                                         Pad_330[0x30];                                     // 0x0330(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
	class APlayerController*                      PrimaryPC;                                         // 0x0360(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UGameplayAbility*                       OwningAbility;                                     // 0x0368(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class AActor*                                 SourceActor;                                       // 0x0378(0x0008)(BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FWorldReticleParameters                ReticleParams;                                     // 0x0380(0x0018)(BlueprintVisible, NoDestructor, ExposeOnSpawn, NativeAccessSpecifierPublic)
	TSubclassOf<class AGameplayAbilityWorldReticle> ReticleClass;                                      // 0x0398(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, ExposeOnSpawn, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayTargetDataFilterHandle        Filter;                                            // 0x03A0(0x0010)(BlueprintVisible, Net, ExposeOnSpawn, NativeAccessSpecifierPublic)
	bool                                          bDebug;                                            // 0x03B0(0x0001)(Edit, BlueprintVisible, Net, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3B1[0x17];                                     // 0x03B1(0x0017)(Fixing Size After Last Property [ Dumper-7 ])
	class UAbilitySystemComponent*                GenericDelegateBoundASC;                           // 0x03C8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(AGameplayAbilityTargetActor, ShouldProduceTargetDataOnServer) == 0x000288, "Member 'AGameplayAbilityTargetActor::ShouldProduceTargetDataOnServer' has a wrong offset!");
static_assert(offsetof(AGameplayAbilityTargetActor, StartLocation) == 0x000290, "Member 'AGameplayAbilityTargetActor::StartLocation' has a wrong offset!");
static_assert(offsetof(AGameplayAbilityTargetActor, PrimaryPC) == 0x000360, "Member 'AGameplayAbilityTargetActor::PrimaryPC' has a wrong offset!");
...
static_assert(offsetof(AGameplayAbilityTargetActor, ReticleClass) == 0x000398, "Member 'AGameplayAbilityTargetActor::ReticleClass' has a wrong offset!");
static_assert(offsetof(AGameplayAbilityTargetActor, Filter) == 0x0003A0, "Member 'AGameplayAbilityTargetActor::Filter' has a wrong offset!");
static_assert(offsetof(AGameplayAbilityTargetActor, bDebug) == 0x0003B0, "Member 'AGameplayAbilityTargetActor::bDebug' has a wrong offset!");
static_assert(offsetof(AGameplayAbilityTargetActor, GenericDelegateBoundASC) == 0x0003C8, "Member 'AGameplayAbilityTargetActor::GenericDelegateBoundASC' has a wrong offset!");
...
{
public:
	float                                         MaxRange;                                          // 0x03D0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FCollisionProfileName                  TraceProfile;                                      // 0x03D4(0x0004)(Edit, BlueprintVisible, Config, NoDestructor, ExposeOnSpawn, NativeAccessSpecifierPublic)
...
static_assert(offsetof(AGameplayAbilityTargetActor_Trace, MaxRange) == 0x0003D0, "Member 'AGameplayAbilityTargetActor_Trace::MaxRange' has a wrong offset!");
static_assert(offsetof(AGameplayAbilityTargetActor_Trace, TraceProfile) == 0x0003D4, "Member 'AGameplayAbilityTargetActor_Trace::TraceProfile' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask, Ability) == 0x000060, "Member 'UAbilityTask::Ability' has a wrong offset!");
static_assert(offsetof(UAbilityTask, AbilitySystemComponent) == 0x000068, "Member 'UAbilityTask::AbilitySystemComponent' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_WaitVelocityChange, OnVelocityChage) == 0x000078, "Member 'UAbilityTask_WaitVelocityChange::OnVelocityChage' has a wrong offset!");
static_assert(offsetof(UAbilityTask_WaitVelocityChange, CachedMovementComponent) == 0x000088, "Member 'UAbilityTask_WaitVelocityChange::CachedMovementComponent' has a wrong offset!");
...
static_assert(sizeof(AAbilitySystemDebugHUD) == 0x000378, "Wrong size on AAbilitySystemDebugHUD");
...
{
public:
	TSubclassOf<class UObject>                    PlacedActorClass;                                  // 0x0408(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, ExposeOnSpawn, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterialInterface*                     PlacedActorMaterial;                               // 0x0410(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, ExposeOnSpawn, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UAbilityTask_WaitMovementModeChange, OnChange) == 0x000078, "Member 'UAbilityTask_WaitMovementModeChange::OnChange' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_WaitInputPress, OnPress) == 0x000078, "Member 'UAbilityTask_WaitInputPress::OnPress' has a wrong offset!");
...
{
public:
	float                                         Radius;                                            // 0x03D0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(AGameplayAbilityTargetActor_Radius, Radius) == 0x0003D0, "Member 'AGameplayAbilityTargetActor_Radius::Radius' has a wrong offset!");
...
{
public:
	struct FWorldReticleParameters                Parameters;                                        // 0x0288(0x0018)(Edit, BlueprintVisible, DisableEditOnTemplate, NoDestructor, ExposeOnSpawn, NativeAccessSpecifierPublic)
	bool                                          bFaceOwnerFlat;                                    // 0x02A0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bSnapToTargetedActor;                              // 0x02A1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsTargetValid;                                    // 0x02A2(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIsTargetAnActor;                                  // 0x02A3(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2A4[0x4];                                      // 0x02A4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class APlayerController*                      PrimaryPC;                                         // 0x02A8(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class AActor*                                 TargetingActor;                                    // 0x02B0(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AGameplayAbilityWorldReticle) == 0x0002B8, "Wrong size on AGameplayAbilityWorldReticle");
static_assert(offsetof(AGameplayAbilityWorldReticle, Parameters) == 0x000288, "Member 'AGameplayAbilityWorldReticle::Parameters' has a wrong offset!");
static_assert(offsetof(AGameplayAbilityWorldReticle, bFaceOwnerFlat) == 0x0002A0, "Member 'AGameplayAbilityWorldReticle::bFaceOwnerFlat' has a wrong offset!");
static_assert(offsetof(AGameplayAbilityWorldReticle, bSnapToTargetedActor) == 0x0002A1, "Member 'AGameplayAbilityWorldReticle::bSnapToTargetedActor' has a wrong offset!");
static_assert(offsetof(AGameplayAbilityWorldReticle, bIsTargetValid) == 0x0002A2, "Member 'AGameplayAbilityWorldReticle::bIsTargetValid' has a wrong offset!");
static_assert(offsetof(AGameplayAbilityWorldReticle, bIsTargetAnActor) == 0x0002A3, "Member 'AGameplayAbilityWorldReticle::bIsTargetAnActor' has a wrong offset!");
static_assert(offsetof(AGameplayAbilityWorldReticle, PrimaryPC) == 0x0002A8, "Member 'AGameplayAbilityWorldReticle::PrimaryPC' has a wrong offset!");
static_assert(offsetof(AGameplayAbilityWorldReticle, TargetingActor) == 0x0002B0, "Member 'AGameplayAbilityWorldReticle::TargetingActor' has a wrong offset!");
...
{
public:
	class UCapsuleComponent*                      CollisionComponent;                                // 0x02B8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class UActorComponent*>                VisualizationComponents;                           // 0x02C0(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AGameplayAbilityWorldReticle_ActorVisualization) == 0x0002D0, "Wrong size on AGameplayAbilityWorldReticle_ActorVisualization");
static_assert(offsetof(AGameplayAbilityWorldReticle_ActorVisualization, CollisionComponent) == 0x0002B8, "Member 'AGameplayAbilityWorldReticle_ActorVisualization::CollisionComponent' has a wrong offset!");
static_assert(offsetof(AGameplayAbilityWorldReticle_ActorVisualization, VisualizationComponents) == 0x0002C0, "Member 'AGameplayAbilityWorldReticle_ActorVisualization::VisualizationComponents' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_ApplyRootMotion_Base, ForceName) == 0x000078, "Member 'UAbilityTask_ApplyRootMotion_Base::ForceName' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotion_Base, FinishVelocityMode) == 0x00007C, "Member 'UAbilityTask_ApplyRootMotion_Base::FinishVelocityMode' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotion_Base, FinishSetVelocity) == 0x000080, "Member 'UAbilityTask_ApplyRootMotion_Base::FinishSetVelocity' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_ApplyRootMotionConstantForce, Strength) == 0x0000E0, "Member 'UAbilityTask_ApplyRootMotionConstantForce::Strength' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionConstantForce, Duration) == 0x0000E4, "Member 'UAbilityTask_ApplyRootMotionConstantForce::Duration' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionConstantForce, bIsAdditive) == 0x0000E8, "Member 'UAbilityTask_ApplyRootMotionConstantForce::bIsAdditive' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionConstantForce, StrengthOverTime) == 0x0000F0, "Member 'UAbilityTask_ApplyRootMotionConstantForce::StrengthOverTime' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionConstantForce, bEnableGravity) == 0x0000F8, "Member 'UAbilityTask_ApplyRootMotionConstantForce::bEnableGravity' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_ApplyRootMotionJumpForce, Distance) == 0x0000F0, "Member 'UAbilityTask_ApplyRootMotionJumpForce::Distance' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionJumpForce, Height) == 0x0000F4, "Member 'UAbilityTask_ApplyRootMotionJumpForce::Height' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionJumpForce, Duration) == 0x0000F8, "Member 'UAbilityTask_ApplyRootMotionJumpForce::Duration' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionJumpForce, MinimumLandedTriggerTime) == 0x0000FC, "Member 'UAbilityTask_ApplyRootMotionJumpForce::MinimumLandedTriggerTime' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionJumpForce, bFinishOnLanded) == 0x000100, "Member 'UAbilityTask_ApplyRootMotionJumpForce::bFinishOnLanded' has a wrong offset!");
...
static_assert(sizeof(UAbilityTask_ApplyRootMotionMoveToActorForce) == 0x000158, "Wrong size on UAbilityTask_ApplyRootMotionMoveToActorForce");
...
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToActorForce, TargetLocation) == 0x0000E8, "Member 'UAbilityTask_ApplyRootMotionMoveToActorForce::TargetLocation' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToActorForce, TargetActor) == 0x000100, "Member 'UAbilityTask_ApplyRootMotionMoveToActorForce::TargetActor' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToActorForce, TargetLocationOffset) == 0x000108, "Member 'UAbilityTask_ApplyRootMotionMoveToActorForce::TargetLocationOffset' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToActorForce, OffsetAlignment) == 0x000120, "Member 'UAbilityTask_ApplyRootMotionMoveToActorForce::OffsetAlignment' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToActorForce, Duration) == 0x000124, "Member 'UAbilityTask_ApplyRootMotionMoveToActorForce::Duration' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToActorForce, bDisableDestinationReachedInterrupt) == 0x000128, "Member 'UAbilityTask_ApplyRootMotionMoveToActorForce::bDisableDestinationReachedInterrupt' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToActorForce, bSetNewMovementMode) == 0x000129, "Member 'UAbilityTask_ApplyRootMotionMoveToActorForce::bSetNewMovementMode' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToActorForce, NewMovementMode) == 0x00012A, "Member 'UAbilityTask_ApplyRootMotionMoveToActorForce::NewMovementMode' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToActorForce, bRestrictSpeedToExpected) == 0x00012B, "Member 'UAbilityTask_ApplyRootMotionMoveToActorForce::bRestrictSpeedToExpected' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToActorForce, PathOffsetCurve) == 0x000130, "Member 'UAbilityTask_ApplyRootMotionMoveToActorForce::PathOffsetCurve' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToActorForce, TimeMappingCurve) == 0x000138, "Member 'UAbilityTask_ApplyRootMotionMoveToActorForce::TimeMappingCurve' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToActorForce, TargetLerpSpeedHorizontalCurve) == 0x000140, "Member 'UAbilityTask_ApplyRootMotionMoveToActorForce::TargetLerpSpeedHorizontalCurve' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToActorForce, TargetLerpSpeedVerticalCurve) == 0x000148, "Member 'UAbilityTask_ApplyRootMotionMoveToActorForce::TargetLerpSpeedVerticalCurve' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToForce, TargetLocation) == 0x0000F0, "Member 'UAbilityTask_ApplyRootMotionMoveToForce::TargetLocation' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToForce, Duration) == 0x000108, "Member 'UAbilityTask_ApplyRootMotionMoveToForce::Duration' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToForce, bSetNewMovementMode) == 0x00010C, "Member 'UAbilityTask_ApplyRootMotionMoveToForce::bSetNewMovementMode' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToForce, NewMovementMode) == 0x00010D, "Member 'UAbilityTask_ApplyRootMotionMoveToForce::NewMovementMode' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToForce, bRestrictSpeedToExpected) == 0x00010E, "Member 'UAbilityTask_ApplyRootMotionMoveToForce::bRestrictSpeedToExpected' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToForce, PathOffsetCurve) == 0x000110, "Member 'UAbilityTask_ApplyRootMotionMoveToForce::PathOffsetCurve' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_ApplyRootMotionRadialForce, FixedWorldDirection) == 0x000110, "Member 'UAbilityTask_ApplyRootMotionRadialForce::FixedWorldDirection' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_MoveToLocation, OnTargetLocationReached) == 0x000078, "Member 'UAbilityTask_MoveToLocation::OnTargetLocationReached' has a wrong offset!");
static_assert(offsetof(UAbilityTask_MoveToLocation, StartLocation) == 0x000090, "Member 'UAbilityTask_MoveToLocation::StartLocation' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_MoveToLocation, DurationOfMovement) == 0x0000C0, "Member 'UAbilityTask_MoveToLocation::DurationOfMovement' has a wrong offset!");
static_assert(offsetof(UAbilityTask_MoveToLocation, LerpCurve) == 0x0000D0, "Member 'UAbilityTask_MoveToLocation::LerpCurve' has a wrong offset!");
static_assert(offsetof(UAbilityTask_MoveToLocation, LerpCurveVector) == 0x0000D8, "Member 'UAbilityTask_MoveToLocation::LerpCurveVector' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_NetworkSyncPoint, OnSync) == 0x000078, "Member 'UAbilityTask_NetworkSyncPoint::OnSync' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_PlayMontageAndWait, OnCompleted) == 0x000078, "Member 'UAbilityTask_PlayMontageAndWait::OnCompleted' has a wrong offset!");
static_assert(offsetof(UAbilityTask_PlayMontageAndWait, OnBlendOut) == 0x000088, "Member 'UAbilityTask_PlayMontageAndWait::OnBlendOut' has a wrong offset!");
static_assert(offsetof(UAbilityTask_PlayMontageAndWait, OnInterrupted) == 0x000098, "Member 'UAbilityTask_PlayMontageAndWait::OnInterrupted' has a wrong offset!");
static_assert(offsetof(UAbilityTask_PlayMontageAndWait, OnCancelled) == 0x0000A8, "Member 'UAbilityTask_PlayMontageAndWait::OnCancelled' has a wrong offset!");
static_assert(offsetof(UAbilityTask_PlayMontageAndWait, MontageToPlay) == 0x0000E0, "Member 'UAbilityTask_PlayMontageAndWait::MontageToPlay' has a wrong offset!");
static_assert(offsetof(UAbilityTask_PlayMontageAndWait, Rate) == 0x0000E8, "Member 'UAbilityTask_PlayMontageAndWait::Rate' has a wrong offset!");
static_assert(offsetof(UAbilityTask_PlayMontageAndWait, StartSection) == 0x0000EC, "Member 'UAbilityTask_PlayMontageAndWait::StartSection' has a wrong offset!");
static_assert(offsetof(UAbilityTask_PlayMontageAndWait, AnimRootMotionTranslationScale) == 0x0000F0, "Member 'UAbilityTask_PlayMontageAndWait::AnimRootMotionTranslationScale' has a wrong offset!");
static_assert(offsetof(UAbilityTask_PlayMontageAndWait, StartTimeSeconds) == 0x0000F4, "Member 'UAbilityTask_PlayMontageAndWait::StartTimeSeconds' has a wrong offset!");
static_assert(offsetof(UAbilityTask_PlayMontageAndWait, bStopWhenAbilityEnds) == 0x0000F8, "Member 'UAbilityTask_PlayMontageAndWait::bStopWhenAbilityEnds' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_Repeat, OnPerformAction) == 0x000078, "Member 'UAbilityTask_Repeat::OnPerformAction' has a wrong offset!");
static_assert(offsetof(UAbilityTask_Repeat, OnFinished) == 0x000088, "Member 'UAbilityTask_Repeat::OnFinished' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_SpawnActor, Success) == 0x000078, "Member 'UAbilityTask_SpawnActor::Success' has a wrong offset!");
static_assert(offsetof(UAbilityTask_SpawnActor, DidNotSpawn) == 0x000088, "Member 'UAbilityTask_SpawnActor::DidNotSpawn' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_StartAbilityState, OnStateEnded) == 0x000078, "Member 'UAbilityTask_StartAbilityState::OnStateEnded' has a wrong offset!");
static_assert(offsetof(UAbilityTask_StartAbilityState, OnStateInterrupted) == 0x000088, "Member 'UAbilityTask_StartAbilityState::OnStateInterrupted' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_VisualizeTargeting, TimeElapsed) == 0x000078, "Member 'UAbilityTask_VisualizeTargeting::TimeElapsed' has a wrong offset!");
...
static_assert(sizeof(UAbilityTask_WaitAbilityActivate) == 0x000128, "Wrong size on UAbilityTask_WaitAbilityActivate");
static_assert(offsetof(UAbilityTask_WaitAbilityActivate, OnActivate) == 0x000078, "Member 'UAbilityTask_WaitAbilityActivate::OnActivate' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_WaitAbilityCommit, OnCommit) == 0x000078, "Member 'UAbilityTask_WaitAbilityCommit::OnCommit' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_WaitAttributeChange, OnChange) == 0x000078, "Member 'UAbilityTask_WaitAttributeChange::OnChange' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_WaitAttributeChangeRatioThreshold, OnChange) == 0x000078, "Member 'UAbilityTask_WaitAttributeChangeRatioThreshold::OnChange' has a wrong offset!");
static_assert(offsetof(UAbilityTask_WaitAttributeChangeRatioThreshold, ExternalOwner) == 0x000130, "Member 'UAbilityTask_WaitAttributeChangeRatioThreshold::ExternalOwner' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_WaitAttributeChangeThreshold, OnChange) == 0x000078, "Member 'UAbilityTask_WaitAttributeChangeThreshold::OnChange' has a wrong offset!");
static_assert(offsetof(UAbilityTask_WaitAttributeChangeThreshold, ExternalOwner) == 0x0000E0, "Member 'UAbilityTask_WaitAttributeChangeThreshold::ExternalOwner' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_WaitCancel, OnCancel) == 0x000078, "Member 'UAbilityTask_WaitCancel::OnCancel' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_WaitConfirm, OnConfirm) == 0x000078, "Member 'UAbilityTask_WaitConfirm::OnConfirm' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_WaitConfirmCancel, OnConfirm) == 0x000078, "Member 'UAbilityTask_WaitConfirmCancel::OnConfirm' has a wrong offset!");
static_assert(offsetof(UAbilityTask_WaitConfirmCancel, OnCancel) == 0x000088, "Member 'UAbilityTask_WaitConfirmCancel::OnCancel' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_WaitDelay, OnFinish) == 0x000078, "Member 'UAbilityTask_WaitDelay::OnFinish' has a wrong offset!");
...
{
public:
	uint8                                         Pad_78[0x128];                                     // 0x0078(0x0128)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAbilityTask_WaitGameplayEffectApplied) == 0x0001B0, "Wrong size on UAbilityTask_WaitGameplayEffectApplied");
static_assert(offsetof(UAbilityTask_WaitGameplayEffectApplied, ExternalOwner) == 0x0001A0, "Member 'UAbilityTask_WaitGameplayEffectApplied::ExternalOwner' has a wrong offset!");
...
static_assert(sizeof(UAbilityTask_WaitGameplayEffectApplied_Self) == 0x0001D0, "Wrong size on UAbilityTask_WaitGameplayEffectApplied_Self");
static_assert(offsetof(UAbilityTask_WaitGameplayEffectApplied_Self, OnApplied) == 0x0001B0, "Member 'UAbilityTask_WaitGameplayEffectApplied_Self::OnApplied' has a wrong offset!");
...
static_assert(sizeof(UAbilityTask_WaitGameplayEffectApplied_Target) == 0x0001D0, "Wrong size on UAbilityTask_WaitGameplayEffectApplied_Target");
static_assert(offsetof(UAbilityTask_WaitGameplayEffectApplied_Target, OnApplied) == 0x0001B0, "Member 'UAbilityTask_WaitGameplayEffectApplied_Target::OnApplied' has a wrong offset!");
...
public:
	...
	class UAbilitySystemComponent*                ExternalOwner;                                     // 0x0110(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_118[0x8];                                      // 0x0118(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAbilityTask_WaitGameplayEffectBlockedImmunity) == 0x000120, "Wrong size on UAbilityTask_WaitGameplayEffectBlockedImmunity");
static_assert(offsetof(UAbilityTask_WaitGameplayEffectBlockedImmunity, bLocked) == 0x000078, "Member 'UAbilityTask_WaitGameplayEffectBlockedImmunity::bLocked' has a wrong offset!");
static_assert(offsetof(UAbilityTask_WaitGameplayEffectBlockedImmunity, ExternalOwner) == 0x000110, "Member 'UAbilityTask_WaitGameplayEffectBlockedImmunity::ExternalOwner' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FGameplayEffectRemovalInfo& GameplayEffectRemovalInfo)> OnRemoved;                                         // 0x0078(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FGameplayEffectRemovalInfo& GameplayEffectRemovalInfo)> InvalidHandle;                                     // 0x0088(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UAbilityTask_WaitGameplayEffectRemoved, OnRemoved) == 0x000078, "Member 'UAbilityTask_WaitGameplayEffectRemoved::OnRemoved' has a wrong offset!");
static_assert(offsetof(UAbilityTask_WaitGameplayEffectRemoved, InvalidHandle) == 0x000088, "Member 'UAbilityTask_WaitGameplayEffectRemoved::InvalidHandle' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_WaitGameplayEffectStackChange, OnChange) == 0x000078, "Member 'UAbilityTask_WaitGameplayEffectStackChange::OnChange' has a wrong offset!");
static_assert(offsetof(UAbilityTask_WaitGameplayEffectStackChange, InvalidHandle) == 0x000088, "Member 'UAbilityTask_WaitGameplayEffectStackChange::InvalidHandle' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_WaitGameplayEvent, EventReceived) == 0x000078, "Member 'UAbilityTask_WaitGameplayEvent::EventReceived' has a wrong offset!");
static_assert(offsetof(UAbilityTask_WaitGameplayEvent, OptionalExternalTarget) == 0x000090, "Member 'UAbilityTask_WaitGameplayEvent::OptionalExternalTarget' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_WaitGameplayTag, OptionalExternalTarget) == 0x000080, "Member 'UAbilityTask_WaitGameplayTag::OptionalExternalTarget' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_WaitGameplayTagAdded, Added) == 0x000098, "Member 'UAbilityTask_WaitGameplayTagAdded::Added' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_WaitGameplayTagRemoved, Removed) == 0x000098, "Member 'UAbilityTask_WaitGameplayTagRemoved::Removed' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_WaitGameplayTagQuery, Triggered) == 0x000138, "Member 'UAbilityTask_WaitGameplayTagQuery::Triggered' has a wrong offset!");
static_assert(offsetof(UAbilityTask_WaitGameplayTagQuery, OptionalExternalTarget) == 0x000148, "Member 'UAbilityTask_WaitGameplayTagQuery::OptionalExternalTarget' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_WaitInputRelease, OnRelease) == 0x000078, "Member 'UAbilityTask_WaitInputRelease::OnRelease' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FGameplayAbilityTargetDataHandle& TargetData)> OnOverlap;                                         // 0x0078(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UAbilityTask_WaitOverlap, OnOverlap) == 0x000078, "Member 'UAbilityTask_WaitOverlap::OnOverlap' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FGameplayAbilityTargetDataHandle& Data)> ValidData;                                         // 0x0078(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FGameplayAbilityTargetDataHandle& Data)> Cancelled;                                         // 0x0088(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UAbilityTask_WaitTargetData, ValidData) == 0x000078, "Member 'UAbilityTask_WaitTargetData::ValidData' has a wrong offset!");
static_assert(offsetof(UAbilityTask_WaitTargetData, Cancelled) == 0x000088, "Member 'UAbilityTask_WaitTargetData::Cancelled' has a wrong offset!");
static_assert(offsetof(UAbilityTask_WaitTargetData, TargetClass) == 0x000098, "Member 'UAbilityTask_WaitTargetData::TargetClass' has a wrong offset!");
static_assert(offsetof(UAbilityTask_WaitTargetData, TargetActor) == 0x0000A0, "Member 'UAbilityTask_WaitTargetData::TargetActor' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_13C[0x19C];                                    // 0x013C(0x019C)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         OutgoingDuration;                                  // 0x02D8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         IncomingDuration;                                  // 0x02DC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2E0[0x20];                                     // 0x02E0(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FString>                         ClientDebugStrings;                                // 0x0300(0x0010)(Net, ZeroConstructor, RepNotify, NativeAccessSpecifierPublic)
	TArray<class FString>                         ServerDebugStrings;                                // 0x0310(0x0010)(Net, ZeroConstructor, RepNotify, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_540[0x210];                                    // 0x0540(0x0210)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayAbilityRepAnimMontage         RepAnimMontageInfo;                                // 0x0750(0x0038)(Net, RepNotify, NoDestructor, Protected, NativeAccessSpecifierProtected)
	...
	struct FActiveGameplayEffectsContainer        ActiveGameplayEffects;                             // 0x0860(0x0480)(Net, Protected, NativeAccessSpecifierProtected)
	...
	uint8                                         Pad_F30[0x128];                                    // 0x0F30(0x0128)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<uint8>                                 BlockedAbilityBindings;                            // 0x1058(0x0010)(Net, ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_1068[0x128];                                   // 0x1068(0x0128)(Fixing Size After Last Property [ Dumper-7 ])
	...
	TArray<class UAttributeSet*>                  SpawnedAttributes;                                 // 0x11F0(0x0010)(ExportObject, Net, ZeroConstructor, Transient, RepNotify, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
	...
	struct FReplicatedPredictionKeyMap            ReplicatedPredictionKeyMap;                        // 0x1278(0x0118)(Net, Transient, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UAbilitySystemComponent, OutgoingDuration) == 0x0002D8, "Member 'UAbilitySystemComponent::OutgoingDuration' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, IncomingDuration) == 0x0002DC, "Member 'UAbilitySystemComponent::IncomingDuration' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, ClientDebugStrings) == 0x000300, "Member 'UAbilitySystemComponent::ClientDebugStrings' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, ServerDebugStrings) == 0x000310, "Member 'UAbilitySystemComponent::ServerDebugStrings' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, UserAbilityActivationInhibited) == 0x000380, "Member 'UAbilitySystemComponent::UserAbilityActivationInhibited' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, ReplicationProxyEnabled) == 0x000381, "Member 'UAbilitySystemComponent::ReplicationProxyEnabled' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, bSuppressGrantAbility) == 0x000382, "Member 'UAbilitySystemComponent::bSuppressGrantAbility' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, bSuppressGameplayCues) == 0x000383, "Member 'UAbilitySystemComponent::bSuppressGameplayCues' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, SpawnedTargetActors) == 0x000388, "Member 'UAbilitySystemComponent::SpawnedTargetActors' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, OwnerActor) == 0x0003C0, "Member 'UAbilitySystemComponent::OwnerActor' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, AvatarActor) == 0x0003C8, "Member 'UAbilitySystemComponent::AvatarActor' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, ActivatableAbilities) == 0x0003E0, "Member 'UAbilitySystemComponent::ActivatableAbilities' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, AllReplicatedInstancedAbilities) == 0x000530, "Member 'UAbilitySystemComponent::AllReplicatedInstancedAbilities' has a wrong offset!");
...
static_assert(offsetof(UAbilitySystemComponent, ActiveGameplayEffects) == 0x000860, "Member 'UAbilitySystemComponent::ActiveGameplayEffects' has a wrong offset!");
...
public:
	...
	bool                                          PredictTargetGameplayEffects;                      // 0x01C8(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          ReplicateActivationOwnedTags;                      // 0x01C9(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UAbilitySystemGlobals) == 0x000218, "Wrong size on UAbilitySystemGlobals");
...
static_assert(offsetof(UAbilitySystemGlobals, bUseDebugTargetFromHud) == 0x000068, "Member 'UAbilitySystemGlobals::bUseDebugTargetFromHud' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailIsDeadTag) == 0x00006C, "Member 'UAbilitySystemGlobals::ActivateFailIsDeadTag' has a wrong offset!");
...
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailCooldownTag) == 0x000074, "Member 'UAbilitySystemGlobals::ActivateFailCooldownTag' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailCooldownName) == 0x000078, "Member 'UAbilitySystemGlobals::ActivateFailCooldownName' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailCostTag) == 0x00007C, "Member 'UAbilitySystemGlobals::ActivateFailCostTag' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailCostName) == 0x000080, "Member 'UAbilitySystemGlobals::ActivateFailCostName' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailTagsBlockedTag) == 0x000084, "Member 'UAbilitySystemGlobals::ActivateFailTagsBlockedTag' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailTagsBlockedName) == 0x000088, "Member 'UAbilitySystemGlobals::ActivateFailTagsBlockedName' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailTagsMissingTag) == 0x00008C, "Member 'UAbilitySystemGlobals::ActivateFailTagsMissingTag' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailTagsMissingName) == 0x000090, "Member 'UAbilitySystemGlobals::ActivateFailTagsMissingName' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailNetworkingTag) == 0x000094, "Member 'UAbilitySystemGlobals::ActivateFailNetworkingTag' has a wrong offset!");
...
static_assert(offsetof(UAbilitySystemGlobals, MinimalReplicationTagCountBits) == 0x00009C, "Member 'UAbilitySystemGlobals::MinimalReplicationTagCountBits' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, TargetDataStructCache) == 0x0000A0, "Member 'UAbilitySystemGlobals::TargetDataStructCache' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, EffectContextStructCache) == 0x0000B0, "Member 'UAbilitySystemGlobals::EffectContextStructCache' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, bAllowGameplayModEvaluationChannels) == 0x0000C0, "Member 'UAbilitySystemGlobals::bAllowGameplayModEvaluationChannels' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, DefaultGameplayModEvaluationChannel) == 0x0000C1, "Member 'UAbilitySystemGlobals::DefaultGameplayModEvaluationChannel' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, GameplayModEvaluationChannelAliases) == 0x0000C4, "Member 'UAbilitySystemGlobals::GameplayModEvaluationChannelAliases' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, GlobalCurveTableName) == 0x0000F0, "Member 'UAbilitySystemGlobals::GlobalCurveTableName' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, GlobalCurveTable) == 0x000108, "Member 'UAbilitySystemGlobals::GlobalCurveTable' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, GlobalAttributeMetaDataTableName) == 0x000110, "Member 'UAbilitySystemGlobals::GlobalAttributeMetaDataTableName' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, GlobalAttributeMetaDataTable) == 0x000128, "Member 'UAbilitySystemGlobals::GlobalAttributeMetaDataTable' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, GlobalAttributeSetDefaultsTableName) == 0x000130, "Member 'UAbilitySystemGlobals::GlobalAttributeSetDefaultsTableName' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, GlobalAttributeSetDefaultsTableNames) == 0x000148, "Member 'UAbilitySystemGlobals::GlobalAttributeSetDefaultsTableNames' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, GlobalAttributeDefaultsTables) == 0x000158, "Member 'UAbilitySystemGlobals::GlobalAttributeDefaultsTables' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, GlobalGameplayCueManagerClass) == 0x000168, "Member 'UAbilitySystemGlobals::GlobalGameplayCueManagerClass' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, GlobalGameplayCueManagerName) == 0x000180, "Member 'UAbilitySystemGlobals::GlobalGameplayCueManagerName' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, GameplayCueNotifyPaths) == 0x000198, "Member 'UAbilitySystemGlobals::GameplayCueNotifyPaths' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, GameplayTagResponseTableName) == 0x0001A8, "Member 'UAbilitySystemGlobals::GameplayTagResponseTableName' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, GameplayTagResponseTable) == 0x0001C0, "Member 'UAbilitySystemGlobals::GameplayTagResponseTable' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, PredictTargetGameplayEffects) == 0x0001C8, "Member 'UAbilitySystemGlobals::PredictTargetGameplayEffects' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, ReplicateActivationOwnedTags) == 0x0001C9, "Member 'UAbilitySystemGlobals::ReplicateActivationOwnedTags' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, GlobalGameplayCueManager) == 0x0001D0, "Member 'UAbilitySystemGlobals::GlobalGameplayCueManager' has a wrong offset!");
...
public:
	...
	class UAbilitySystemComponent*                AbilitySystemComponent;                            // 0x0350(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	bool                                          bAutoDestroyOnRemove;                              // 0x0288(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_289[0x3];                                      // 0x0289(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         AutoDestroyDelay;                                  // 0x028C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          WarnIfTimelineIsStillRunning;                      // 0x0290(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          WarnIfLatentActionIsStillRunning;                  // 0x0291(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_292[0x2];                                      // 0x0292(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTag                           GameplayCueTag;                                    // 0x0294(0x0004)(Edit, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   GameplayCueName;                                   // 0x0298(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, AssetRegistrySearchable, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAutoAttachToOwner;                                // 0x029C(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          IsOverride;                                        // 0x029D(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUniqueInstancePerInstigator;                      // 0x029E(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUniqueInstancePerSourceObject;                    // 0x029F(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAllowMultipleOnActiveEvents;                      // 0x02A0(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAllowMultipleWhileActiveEvents;                   // 0x02A1(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2A2[0x2];                                      // 0x02A2(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         NumPreallocatedInstances;                          // 0x02A4(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AGameplayCueNotify_Actor) == 0x0002E0, "Wrong size on AGameplayCueNotify_Actor");
static_assert(offsetof(AGameplayCueNotify_Actor, bAutoDestroyOnRemove) == 0x000288, "Member 'AGameplayCueNotify_Actor::bAutoDestroyOnRemove' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Actor, AutoDestroyDelay) == 0x00028C, "Member 'AGameplayCueNotify_Actor::AutoDestroyDelay' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Actor, WarnIfTimelineIsStillRunning) == 0x000290, "Member 'AGameplayCueNotify_Actor::WarnIfTimelineIsStillRunning' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Actor, WarnIfLatentActionIsStillRunning) == 0x000291, "Member 'AGameplayCueNotify_Actor::WarnIfLatentActionIsStillRunning' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Actor, GameplayCueTag) == 0x000294, "Member 'AGameplayCueNotify_Actor::GameplayCueTag' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Actor, GameplayCueName) == 0x000298, "Member 'AGameplayCueNotify_Actor::GameplayCueName' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Actor, bAutoAttachToOwner) == 0x00029C, "Member 'AGameplayCueNotify_Actor::bAutoAttachToOwner' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Actor, IsOverride) == 0x00029D, "Member 'AGameplayCueNotify_Actor::IsOverride' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Actor, bUniqueInstancePerInstigator) == 0x00029E, "Member 'AGameplayCueNotify_Actor::bUniqueInstancePerInstigator' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Actor, bUniqueInstancePerSourceObject) == 0x00029F, "Member 'AGameplayCueNotify_Actor::bUniqueInstancePerSourceObject' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Actor, bAllowMultipleOnActiveEvents) == 0x0002A0, "Member 'AGameplayCueNotify_Actor::bAllowMultipleOnActiveEvents' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Actor, bAllowMultipleWhileActiveEvents) == 0x0002A1, "Member 'AGameplayCueNotify_Actor::bAllowMultipleWhileActiveEvents' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Actor, NumPreallocatedInstances) == 0x0002A4, "Member 'AGameplayCueNotify_Actor::NumPreallocatedInstances' has a wrong offset!");
...
static_assert(offsetof(UGameplayCueNotify_Static, GameplayCueName) == 0x00002C, "Member 'UGameplayCueNotify_Static::GameplayCueName' has a wrong offset!");
static_assert(offsetof(UGameplayCueNotify_Static, IsOverride) == 0x000030, "Member 'UGameplayCueNotify_Static::IsOverride' has a wrong offset!");
...
static_assert(offsetof(UGameplayCueNotify_Burst, DefaultSpawnCondition) == 0x000038, "Member 'UGameplayCueNotify_Burst::DefaultSpawnCondition' has a wrong offset!");
static_assert(offsetof(UGameplayCueNotify_Burst, DefaultPlacementInfo) == 0x000070, "Member 'UGameplayCueNotify_Burst::DefaultPlacementInfo' has a wrong offset!");
static_assert(offsetof(UGameplayCueNotify_Burst, BurstEffects) == 0x0000B0, "Member 'UGameplayCueNotify_Burst::BurstEffects' has a wrong offset!");

// Class GameplayAbilities.GameplayCueNotify_BurstLatent
// 0x0368 (0x0648 - 0x02E0)
class AGameplayCueNotify_BurstLatent final : public AGameplayCueNotify_Actor
{
public:
	struct FGameplayCueNotify_SpawnCondition      DefaultSpawnCondition;                             // 0x02E0(0x0038)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueNotify_PlacementInfo       DefaultPlacementInfo;                              // 0x0318(0x0040)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueNotify_BurstEffects        BurstEffects;                                      // 0x0358(0x0298)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueNotify_SpawnResult         BurstSpawnResults;                                 // 0x05F0(0x0058)(BlueprintVisible, BlueprintReadOnly, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AGameplayCueNotify_BurstLatent) == 0x000648, "Wrong size on AGameplayCueNotify_BurstLatent");
static_assert(offsetof(AGameplayCueNotify_BurstLatent, DefaultSpawnCondition) == 0x0002E0, "Member 'AGameplayCueNotify_BurstLatent::DefaultSpawnCondition' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_BurstLatent, DefaultPlacementInfo) == 0x000318, "Member 'AGameplayCueNotify_BurstLatent::DefaultPlacementInfo' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_BurstLatent, BurstEffects) == 0x000358, "Member 'AGameplayCueNotify_BurstLatent::BurstEffects' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_BurstLatent, BurstSpawnResults) == 0x0005F0, "Member 'AGameplayCueNotify_BurstLatent::BurstSpawnResults' has a wrong offset!");
...
static_assert(offsetof(UGameplayCueNotify_HitImpact, sound) == 0x000038, "Member 'UGameplayCueNotify_HitImpact::sound' has a wrong offset!");
static_assert(offsetof(UGameplayCueNotify_HitImpact, ParticleSystem) == 0x000040, "Member 'UGameplayCueNotify_HitImpact::ParticleSystem' has a wrong offset!");

// Class GameplayAbilities.GameplayCueNotify_Looping
// 0x0B98 (0x0E78 - 0x02E0)
class AGameplayCueNotify_Looping final : public AGameplayCueNotify_Actor
{
public:
	struct FGameplayCueNotify_SpawnCondition      DefaultSpawnCondition;                             // 0x02E0(0x0038)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueNotify_PlacementInfo       DefaultPlacementInfo;                              // 0x0318(0x0040)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueNotify_BurstEffects        ApplicationEffects;                                // 0x0358(0x0298)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueNotify_SpawnResult         ApplicationSpawnResults;                           // 0x05F0(0x0058)(BlueprintVisible, BlueprintReadOnly, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueNotify_LoopingEffects      LoopingEffects;                                    // 0x0648(0x01F0)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	...
	struct FGameplayCueNotify_BurstEffects        RecurringEffects;                                  // 0x0890(0x0298)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueNotify_SpawnResult         RecurringSpawnResults;                             // 0x0B28(0x0058)(BlueprintVisible, BlueprintReadOnly, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueNotify_BurstEffects        RemovalEffects;                                    // 0x0B80(0x0298)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueNotify_SpawnResult         RemovalSpawnResults;                               // 0x0E18(0x0058)(BlueprintVisible, BlueprintReadOnly, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AGameplayCueNotify_Looping) == 0x000E78, "Wrong size on AGameplayCueNotify_Looping");
static_assert(offsetof(AGameplayCueNotify_Looping, DefaultSpawnCondition) == 0x0002E0, "Member 'AGameplayCueNotify_Looping::DefaultSpawnCondition' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Looping, DefaultPlacementInfo) == 0x000318, "Member 'AGameplayCueNotify_Looping::DefaultPlacementInfo' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Looping, ApplicationEffects) == 0x000358, "Member 'AGameplayCueNotify_Looping::ApplicationEffects' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Looping, ApplicationSpawnResults) == 0x0005F0, "Member 'AGameplayCueNotify_Looping::ApplicationSpawnResults' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Looping, LoopingEffects) == 0x000648, "Member 'AGameplayCueNotify_Looping::LoopingEffects' has a wrong offset!");
...
static_assert(offsetof(AGameplayCueNotify_Looping, RecurringSpawnResults) == 0x000B28, "Member 'AGameplayCueNotify_Looping::RecurringSpawnResults' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Looping, RemovalEffects) == 0x000B80, "Member 'AGameplayCueNotify_Looping::RemovalEffects' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Looping, RemovalSpawnResults) == 0x000E18, "Member 'AGameplayCueNotify_Looping::RemovalSpawnResults' has a wrong offset!");
...
public:
	...
	class UGameplayEffectUIData*                  UIData;                                            // 0x0308(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	EGameplayEffectStackingType                   StackingType;                                      // 0x0839(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	EGameplayEffectStackingDurationPolicy         StackDurationRefreshPolicy;                        // 0x0840(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EGameplayEffectStackingPeriodPolicy           StackPeriodResetPolicy;                            // 0x0841(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EGameplayEffectStackingExpirationPolicy       StackExpirationPolicy;                             // 0x0842(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UGameplayEffect) == 0x000858, "Wrong size on UGameplayEffect");
...
static_assert(offsetof(UGameplayEffect, Period) == 0x000210, "Member 'UGameplayEffect::Period' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, bExecutePeriodicEffectOnApplication) == 0x000238, "Member 'UGameplayEffect::bExecutePeriodicEffectOnApplication' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, PeriodicInhibitionPolicy) == 0x000239, "Member 'UGameplayEffect::PeriodicInhibitionPolicy' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, Modifiers) == 0x000240, "Member 'UGameplayEffect::Modifiers' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, Executions) == 0x000250, "Member 'UGameplayEffect::Executions' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, ChanceToApplyToTarget) == 0x000260, "Member 'UGameplayEffect::ChanceToApplyToTarget' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, ApplicationRequirements) == 0x000288, "Member 'UGameplayEffect::ApplicationRequirements' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, TargetEffectClasses) == 0x000298, "Member 'UGameplayEffect::TargetEffectClasses' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, ConditionalGameplayEffects) == 0x0002A8, "Member 'UGameplayEffect::ConditionalGameplayEffects' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, OverflowEffects) == 0x0002B8, "Member 'UGameplayEffect::OverflowEffects' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, bDenyOverflowApplication) == 0x0002C8, "Member 'UGameplayEffect::bDenyOverflowApplication' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, bClearStackOnOverflow) == 0x0002C9, "Member 'UGameplayEffect::bClearStackOnOverflow' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, PrematureExpirationEffectClasses) == 0x0002D0, "Member 'UGameplayEffect::PrematureExpirationEffectClasses' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, RoutineExpirationEffectClasses) == 0x0002E0, "Member 'UGameplayEffect::RoutineExpirationEffectClasses' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, bRequireModifierSuccessToTriggerCues) == 0x0002F0, "Member 'UGameplayEffect::bRequireModifierSuccessToTriggerCues' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, bSuppressStackingCues) == 0x0002F1, "Member 'UGameplayEffect::bSuppressStackingCues' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, GameplayCues) == 0x0002F8, "Member 'UGameplayEffect::GameplayCues' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, UIData) == 0x000308, "Member 'UGameplayEffect::UIData' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, InheritableGameplayEffectTags) == 0x000310, "Member 'UGameplayEffect::InheritableGameplayEffectTags' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, InheritableOwnedTagsContainer) == 0x000370, "Member 'UGameplayEffect::InheritableOwnedTagsContainer' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, InheritableBlockedAbilityTagsContainer) == 0x0003D0, "Member 'UGameplayEffect::InheritableBlockedAbilityTagsContainer' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, OngoingTagRequirements) == 0x000430, "Member 'UGameplayEffect::OngoingTagRequirements' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, ApplicationTagRequirements) == 0x000470, "Member 'UGameplayEffect::ApplicationTagRequirements' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, RemovalTagRequirements) == 0x0004B0, "Member 'UGameplayEffect::RemovalTagRequirements' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, RemoveGameplayEffectsWithTags) == 0x0004F0, "Member 'UGameplayEffect::RemoveGameplayEffectsWithTags' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, GrantedApplicationImmunityTags) == 0x000550, "Member 'UGameplayEffect::GrantedApplicationImmunityTags' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, GrantedApplicationImmunityQuery) == 0x000590, "Member 'UGameplayEffect::GrantedApplicationImmunityQuery' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, RemoveGameplayEffectQuery) == 0x0006E8, "Member 'UGameplayEffect::RemoveGameplayEffectQuery' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, StackingType) == 0x000839, "Member 'UGameplayEffect::StackingType' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, StackLimitCount) == 0x00083C, "Member 'UGameplayEffect::StackLimitCount' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, StackDurationRefreshPolicy) == 0x000840, "Member 'UGameplayEffect::StackDurationRefreshPolicy' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, StackPeriodResetPolicy) == 0x000841, "Member 'UGameplayEffect::StackPeriodResetPolicy' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, StackExpirationPolicy) == 0x000842, "Member 'UGameplayEffect::StackExpirationPolicy' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, GrantedAbilities) == 0x000848, "Member 'UGameplayEffect::GrantedAbilities' has a wrong offset!");
...
public:
	...
	const struct FGameplayTagContainer GetSourceActorTags(const struct FGameplayEffectSpec& EffectSpec);
	struct FGameplayTagContainer GetSourceAggregatedTags(const struct FGameplayEffectSpec& EffectSpec);
	const struct FGameplayTagContainer GetSourceSpecTags(const struct FGameplayEffectSpec& EffectSpec);
	const struct FGameplayTagContainer GetTargetActorTags(const struct FGameplayEffectSpec& EffectSpec);
	struct FGameplayTagContainer GetTargetAggregatedTags(const struct FGameplayEffectSpec& EffectSpec);
	const struct FGameplayTagContainer GetTargetSpecTags(const struct FGameplayEffectSpec& EffectSpec);
