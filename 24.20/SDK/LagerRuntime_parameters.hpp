...
// Function LagerRuntime.FortAthenaLivingWorldManager.LivingWorldManagerDisplaySpawnPoints
// 0x0008 (0x0008 - 0x0000)
struct FortAthenaLivingWorldManager_LivingWorldManagerDisplaySpawnPoints final
{
public:
	...
	float                                         MinDisplayDistance;                                // 0x0004(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FortAthenaLivingWorldManager_LivingWorldManagerDisplaySpawnPoints) == 0x000004, "Wrong alignment on FortAthenaLivingWorldManager_LivingWorldManagerDisplaySpawnPoints");
static_assert(sizeof(FortAthenaLivingWorldManager_LivingWorldManagerDisplaySpawnPoints) == 0x000008, "Wrong size on FortAthenaLivingWorldManager_LivingWorldManagerDisplaySpawnPoints");
static_assert(offsetof(FortAthenaLivingWorldManager_LivingWorldManagerDisplaySpawnPoints, MaxDisplayDistance) == 0x000000, "Member 'FortAthenaLivingWorldManager_LivingWorldManagerDisplaySpawnPoints::MaxDisplayDistance' has a wrong offset!");
static_assert(offsetof(FortAthenaLivingWorldManager_LivingWorldManagerDisplaySpawnPoints, MinDisplayDistance) == 0x000004, "Member 'FortAthenaLivingWorldManager_LivingWorldManagerDisplaySpawnPoints::MinDisplayDistance' has a wrong offset!");
...
public:
	...
	class AActor*                                 ActorDensityReservoir;                             // 0x0038(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFortAthenaLivingWorldEncounterInstance* ReturnValue;                                       // 0x0040(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
