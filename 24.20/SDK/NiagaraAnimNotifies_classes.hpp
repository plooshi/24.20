...
static_assert(sizeof(UAnimNotifyState_TimedNiagaraEffectAdvanced) == 0x0000E0, "Wrong size on UAnimNotifyState_TimedNiagaraEffectAdvanced");
...
static_assert(offsetof(UAnimNotifyState_TimedNiagaraEffectAdvanced, AnimCurves) == 0x000080, "Member 'UAnimNotifyState_TimedNiagaraEffectAdvanced::AnimCurves' has a wrong offset!");
