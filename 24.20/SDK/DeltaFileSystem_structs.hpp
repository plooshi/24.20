...
static_assert(alignof(FDeltaTrackingHandles) == 0x000010, "Wrong alignment on FDeltaTrackingHandles");
static_assert(sizeof(FDeltaTrackingHandles) == 0x000050, "Wrong size on FDeltaTrackingHandles");
