...
static_assert(sizeof(FRigUnit_RigLogic) == 0x0000C0, "Wrong size on FRigUnit_RigLogic");
static_assert(offsetof(FRigUnit_RigLogic, Data) == 0x000038, "Member 'FRigUnit_RigLogic::Data' has a wrong offset!");
