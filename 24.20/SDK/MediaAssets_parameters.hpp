...
static_assert(sizeof(MediaSource_SetMediaOptionBool) == 0x000008, "Wrong size on MediaSource_SetMediaOptionBool");
...
static_assert(offsetof(MediaSource_SetMediaOptionBool, Value) == 0x000004, "Member 'MediaSource_SetMediaOptionBool::Value' has a wrong offset!");
...
static_assert(sizeof(MediaSource_SetMediaOptionFloat) == 0x000008, "Wrong size on MediaSource_SetMediaOptionFloat");
...
static_assert(offsetof(MediaSource_SetMediaOptionFloat, Value) == 0x000004, "Member 'MediaSource_SetMediaOptionFloat::Value' has a wrong offset!");
...
static_assert(sizeof(MediaPlayer_SetDesiredPlayerName) == 0x000004, "Wrong size on MediaPlayer_SetDesiredPlayerName");
...
static_assert(sizeof(MediaPlayer_GetDesiredPlayerName) == 0x000004, "Wrong size on MediaPlayer_GetDesiredPlayerName");
...
static_assert(sizeof(MediaPlayer_GetPlayerName) == 0x000004, "Wrong size on MediaPlayer_GetPlayerName");
