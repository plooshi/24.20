...
static_assert(sizeof(ARBlueprintLibrary_RemoveARPinFromLocalStore) == 0x000004, "Wrong size on ARBlueprintLibrary_RemoveARPinFromLocalStore");
...
static_assert(sizeof(ARTrackedGeometry_GetDebugName) == 0x000004, "Wrong size on ARTrackedGeometry_GetDebugName");
...
static_assert(sizeof(ARPin_GetDebugName) == 0x000004, "Wrong size on ARPin_GetDebugName");
