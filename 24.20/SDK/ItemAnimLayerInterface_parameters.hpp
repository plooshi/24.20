...
static_assert(sizeof(ItemAnimLayerInterface_C_ItemAimOffset) == 0x000048, "Wrong size on ItemAnimLayerInterface_C_ItemAimOffset");
...
static_assert(offsetof(ItemAnimLayerInterface_C_ItemAimOffset, Yaw) == 0x000018, "Member 'ItemAnimLayerInterface_C_ItemAimOffset::Yaw' has a wrong offset!");
static_assert(offsetof(ItemAnimLayerInterface_C_ItemAimOffset, Pitch) == 0x000020, "Member 'ItemAnimLayerInterface_C_ItemAimOffset::Pitch' has a wrong offset!");
static_assert(offsetof(ItemAnimLayerInterface_C_ItemAimOffset, InPose_UpperLowerPreMeleeAO) == 0x000028, "Member 'ItemAnimLayerInterface_C_ItemAimOffset::InPose_UpperLowerPreMeleeAO' has a wrong offset!");
static_assert(offsetof(ItemAnimLayerInterface_C_ItemAimOffset, ItemAimOffset_0) == 0x000038, "Member 'ItemAnimLayerInterface_C_ItemAimOffset::ItemAimOffset_0' has a wrong offset!");
...
static_assert(alignof(ItemAnimLayerInterface_C_ItemFinalPoseOverride) == 0x000008, "Wrong alignment on ItemAnimLayerInterface_C_ItemFinalPoseOverride");
static_assert(sizeof(ItemAnimLayerInterface_C_ItemFinalPoseOverride) == 0x000020, "Wrong size on ItemAnimLayerInterface_C_ItemFinalPoseOverride");
static_assert(offsetof(ItemAnimLayerInterface_C_ItemFinalPoseOverride, InFinalPose) == 0x000000, "Member 'ItemAnimLayerInterface_C_ItemFinalPoseOverride::InFinalPose' has a wrong offset!");
static_assert(offsetof(ItemAnimLayerInterface_C_ItemFinalPoseOverride, ItemFinalPoseOverride_0) == 0x000010, "Member 'ItemAnimLayerInterface_C_ItemFinalPoseOverride::ItemFinalPoseOverride_0' has a wrong offset!");
...
static_assert(sizeof(ItemAnimLayerInterface_C_ItemUpperBody) == 0x000280, "Wrong size on ItemAnimLayerInterface_C_ItemUpperBody");
...
static_assert(offsetof(ItemAnimLayerInterface_C_ItemUpperBody, ItemUpperBody_0) == 0x000270, "Member 'ItemAnimLayerInterface_C_ItemUpperBody::ItemUpperBody_0' has a wrong offset!");
