...
{
public:
	class UDataflowComponent*                     DataflowComponent;                                 // 0x0288(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ADataflowActor) == 0x000290, "Wrong size on ADataflowActor");
static_assert(offsetof(ADataflowActor, DataflowComponent) == 0x000288, "Member 'ADataflowActor::DataflowComponent' has a wrong offset!");
