...
static_assert(sizeof(AnimNotify_FootStep_C_Received_Notify) == 0x000058, "Wrong size on AnimNotify_FootStep_C_Received_Notify");
...
static_assert(offsetof(AnimNotify_FootStep_C_Received_Notify, ReturnValue) == 0x000038, "Member 'AnimNotify_FootStep_C_Received_Notify::ReturnValue' has a wrong offset!");
static_assert(offsetof(AnimNotify_FootStep_C_Received_Notify, CallFunc_GetOwner_ReturnValue) == 0x000040, "Member 'AnimNotify_FootStep_C_Received_Notify::CallFunc_GetOwner_ReturnValue' has a wrong offset!");
static_assert(offsetof(AnimNotify_FootStep_C_Received_Notify, K2Node_DynamicCast_AsFort_Pawn) == 0x000048, "Member 'AnimNotify_FootStep_C_Received_Notify::K2Node_DynamicCast_AsFort_Pawn' has a wrong offset!");
static_assert(offsetof(AnimNotify_FootStep_C_Received_Notify, K2Node_DynamicCast_bSuccess) == 0x000050, "Member 'AnimNotify_FootStep_C_Received_Notify::K2Node_DynamicCast_bSuccess' has a wrong offset!");
