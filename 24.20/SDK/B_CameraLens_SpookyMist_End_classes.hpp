...
static_assert(sizeof(AB_CameraLens_SpookyMist_End_C) == 0x000380, "Wrong size on AB_CameraLens_SpookyMist_End_C");
static_assert(offsetof(AB_CameraLens_SpookyMist_End_C, UberGraphFrame) == 0x000370, "Member 'AB_CameraLens_SpookyMist_End_C::UberGraphFrame' has a wrong offset!");
