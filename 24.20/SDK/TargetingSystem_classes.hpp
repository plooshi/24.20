...
{
public:
	TMulticastInlineDelegate<void(const struct FTargetingRequestHandle& TargetingRequestHandle)> OnTargetReady;                                     // 0x0078(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UAbilityTask_PerformTargeting) == 0x0000A8, "Wrong size on UAbilityTask_PerformTargeting");
static_assert(offsetof(UAbilityTask_PerformTargeting, OnTargetReady) == 0x000078, "Member 'UAbilityTask_PerformTargeting::OnTargetReady' has a wrong offset!");
...
static_assert(sizeof(UTargetingSubsystem) == 0x000058, "Wrong size on UTargetingSubsystem");
