...
static_assert(alignof(UGE_ExtraLifeRevive_C) == 0x000008, "Wrong alignment on UGE_ExtraLifeRevive_C");
static_assert(sizeof(UGE_ExtraLifeRevive_C) == 0x000858, "Wrong size on UGE_ExtraLifeRevive_C");
