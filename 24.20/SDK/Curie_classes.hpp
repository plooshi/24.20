...
static_assert(sizeof(UCurieManager) == 0x000630, "Wrong size on UCurieManager");
...
static_assert(offsetof(UCurieManager, CurieManagerRegistryName) == 0x0000A8, "Member 'UCurieManager::CurieManagerRegistryName' has a wrong offset!");
static_assert(offsetof(UCurieManager, MaterialDataRegistryName) == 0x0000AC, "Member 'UCurieManager::MaterialDataRegistryName' has a wrong offset!");
static_assert(offsetof(UCurieManager, ElementDataRegistryName) == 0x0000B0, "Member 'UCurieManager::ElementDataRegistryName' has a wrong offset!");
static_assert(offsetof(UCurieManager, EntityStateDataRegistryName) == 0x0000B4, "Member 'UCurieManager::EntityStateDataRegistryName' has a wrong offset!");
...
static_assert(offsetof(UCurieManager, CurieManagerComponents) == 0x000530, "Member 'UCurieManager::CurieManagerComponents' has a wrong offset!");
...
static_assert(alignof(ICurieManagerComponentInterface) == 0x000008, "Wrong alignment on ICurieManagerComponentInterface");
static_assert(sizeof(ICurieManagerComponentInterface) == 0x000028, "Wrong size on ICurieManagerComponentInterface");
...
static_assert(alignof(UCurieManagerComponentConfig) == 0x000008, "Wrong alignment on UCurieManagerComponentConfig");
static_assert(sizeof(UCurieManagerComponentConfig) == 0x000040, "Wrong size on UCurieManagerComponentConfig");
static_assert(offsetof(UCurieManagerComponentConfig, ConfigName) == 0x000038, "Member 'UCurieManagerComponentConfig::ConfigName' has a wrong offset!");
static_assert(offsetof(UCurieManagerComponentConfig, ConfigTag) == 0x00003C, "Member 'UCurieManagerComponentConfig::ConfigTag' has a wrong offset!");
...
static_assert(alignof(UCurieManagerComponent) == 0x000008, "Wrong alignment on UCurieManagerComponent");
static_assert(sizeof(UCurieManagerComponent) == 0x000030, "Wrong size on UCurieManagerComponent");
static_assert(offsetof(UCurieManagerComponent, CachedConfig) == 0x000028, "Member 'UCurieManagerComponent::CachedConfig' has a wrong offset!");
