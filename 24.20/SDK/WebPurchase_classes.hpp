...
public:
	...
	class UWBP_UIKit_Button_Quiet_C*              Button_Back;                                       // 0x0510(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UCircularThrobber*                      Throbber;                                          // 0x0518(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UWebPurchase_C) == 0x000520, "Wrong size on UWebPurchase_C");
static_assert(offsetof(UWebPurchase_C, UberGraphFrame) == 0x000508, "Member 'UWebPurchase_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWebPurchase_C, Button_Back) == 0x000510, "Member 'UWebPurchase_C::Button_Back' has a wrong offset!");
static_assert(offsetof(UWebPurchase_C, Throbber) == 0x000518, "Member 'UWebPurchase_C::Throbber' has a wrong offset!");
