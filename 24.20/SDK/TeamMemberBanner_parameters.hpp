...
static_assert(alignof(TeamMemberBanner_C_HandleMouseHoverVisualState) == 0x000010, "Wrong alignment on TeamMemberBanner_C_HandleMouseHoverVisualState");
static_assert(sizeof(TeamMemberBanner_C_HandleMouseHoverVisualState) == 0x0000E0, "Wrong size on TeamMemberBanner_C_HandleMouseHoverVisualState");
