...
static_assert(sizeof(FCatalogItemPrice) == 0x000050, "Wrong size on FCatalogItemPrice");
...
static_assert(offsetof(FCatalogItemPrice, AppStoreId) == 0x000048, "Member 'FCatalogItemPrice::AppStoreId' has a wrong offset!");
...
static_assert(offsetof(FAppStoreCheckoutConfig, AppStore) == 0x000000, "Member 'FAppStoreCheckoutConfig::AppStore' has a wrong offset!");
static_assert(offsetof(FAppStoreCheckoutConfig, CheckoutType) == 0x000001, "Member 'FAppStoreCheckoutConfig::CheckoutType' has a wrong offset!");
...
public:
	...
	class FString                                 PurchaseCorrelationId;                             // 0x0030(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FCatalogRedeemRealMoneyPurchasesInfo) == 0x000058, "Wrong size on FCatalogRedeemRealMoneyPurchasesInfo");
static_assert(offsetof(FCatalogRedeemRealMoneyPurchasesInfo, AppStore) == 0x000000, "Member 'FCatalogRedeemRealMoneyPurchasesInfo::AppStore' has a wrong offset!");
static_assert(offsetof(FCatalogRedeemRealMoneyPurchasesInfo, AuthTokens) == 0x000008, "Member 'FCatalogRedeemRealMoneyPurchasesInfo::AuthTokens' has a wrong offset!");
static_assert(offsetof(FCatalogRedeemRealMoneyPurchasesInfo, ReceiptIds) == 0x000018, "Member 'FCatalogRedeemRealMoneyPurchasesInfo::ReceiptIds' has a wrong offset!");
static_assert(offsetof(FCatalogRedeemRealMoneyPurchasesInfo, RefreshType) == 0x000028, "Member 'FCatalogRedeemRealMoneyPurchasesInfo::RefreshType' has a wrong offset!");
static_assert(offsetof(FCatalogRedeemRealMoneyPurchasesInfo, VerifierModeOverride) == 0x000029, "Member 'FCatalogRedeemRealMoneyPurchasesInfo::VerifierModeOverride' has a wrong offset!");
static_assert(offsetof(FCatalogRedeemRealMoneyPurchasesInfo, PurchaseCorrelationId) == 0x000030, "Member 'FCatalogRedeemRealMoneyPurchasesInfo::PurchaseCorrelationId' has a wrong offset!");
...
static_assert(sizeof(FCatalogOffer) == 0x000260, "Wrong size on FCatalogOffer");
...
static_assert(offsetof(FCatalogOffer, MetaAssetInfo) == 0x0001C0, "Member 'FCatalogOffer::MetaAssetInfo' has a wrong offset!");
static_assert(offsetof(FCatalogOffer, DisplayAssetPath) == 0x0001F0, "Member 'FCatalogOffer::DisplayAssetPath' has a wrong offset!");
static_assert(offsetof(FCatalogOffer, ItemGrants) == 0x000200, "Member 'FCatalogOffer::ItemGrants' has a wrong offset!");
static_assert(offsetof(FCatalogOffer, Requirements) == 0x000210, "Member 'FCatalogOffer::Requirements' has a wrong offset!");
static_assert(offsetof(FCatalogOffer, GiftInfo) == 0x000220, "Member 'FCatalogOffer::GiftInfo' has a wrong offset!");
static_assert(offsetof(FCatalogOffer, Refundable) == 0x000248, "Member 'FCatalogOffer::Refundable' has a wrong offset!");
static_assert(offsetof(FCatalogOffer, DenyItemTemplateIds) == 0x000250, "Member 'FCatalogOffer::DenyItemTemplateIds' has a wrong offset!");
...
static_assert(offsetof(FMcpEntitlementRefreshTimerInfo, NextEntitlementRefresh) == 0x000000, "Member 'FMcpEntitlementRefreshTimerInfo::NextEntitlementRefresh' has a wrong offset!");
static_assert(offsetof(FMcpEntitlementRefreshTimerInfo, MustRefreshAuthBy) == 0x000008, "Member 'FMcpEntitlementRefreshTimerInfo::MustRefreshAuthBy' has a wrong offset!");
static_assert(offsetof(FMcpEntitlementRefreshTimerInfo, LastAuthRefresh) == 0x000010, "Member 'FMcpEntitlementRefreshTimerInfo::LastAuthRefresh' has a wrong offset!");
...
static_assert(sizeof(FMcpInAppPurchases) == 0x0000D0, "Wrong size on FMcpInAppPurchases");
static_assert(offsetof(FMcpInAppPurchases, Receipts) == 0x000000, "Member 'FMcpInAppPurchases::Receipts' has a wrong offset!");
static_assert(offsetof(FMcpInAppPurchases, IgnoredReceipts) == 0x000010, "Member 'FMcpInAppPurchases::IgnoredReceipts' has a wrong offset!");
static_assert(offsetof(FMcpInAppPurchases, Fulfillments) == 0x000020, "Member 'FMcpInAppPurchases::Fulfillments' has a wrong offset!");
static_assert(offsetof(FMcpInAppPurchases, FulfillmentCounts) == 0x000030, "Member 'FMcpInAppPurchases::FulfillmentCounts' has a wrong offset!");
static_assert(offsetof(FMcpInAppPurchases, RefreshTimers) == 0x000080, "Member 'FMcpInAppPurchases::RefreshTimers' has a wrong offset!");
