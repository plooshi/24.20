...
static_assert(sizeof(UShowdownEventTileInfo_C) == 0x000818, "Wrong size on UShowdownEventTileInfo_C");
static_assert(offsetof(UShowdownEventTileInfo_C, UberGraphFrame) == 0x000718, "Member 'UShowdownEventTileInfo_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UShowdownEventTileInfo_C, FocusPin) == 0x000720, "Member 'UShowdownEventTileInfo_C::FocusPin' has a wrong offset!");
static_assert(offsetof(UShowdownEventTileInfo_C, HideSocketShadow_Past) == 0x000728, "Member 'UShowdownEventTileInfo_C::HideSocketShadow_Past' has a wrong offset!");
static_assert(offsetof(UShowdownEventTileInfo_C, HideSocketShadow) == 0x000730, "Member 'UShowdownEventTileInfo_C::HideSocketShadow' has a wrong offset!");
static_assert(offsetof(UShowdownEventTileInfo_C, Focus) == 0x000738, "Member 'UShowdownEventTileInfo_C::Focus' has a wrong offset!");
static_assert(offsetof(UShowdownEventTileInfo_C, Focus_Ended) == 0x000740, "Member 'UShowdownEventTileInfo_C::Focus_Ended' has a wrong offset!");
static_assert(offsetof(UShowdownEventTileInfo_C, TransitionSize) == 0x000748, "Member 'UShowdownEventTileInfo_C::TransitionSize' has a wrong offset!");
static_assert(offsetof(UShowdownEventTileInfo_C, CommonBorder_Date) == 0x000750, "Member 'UShowdownEventTileInfo_C::CommonBorder_Date' has a wrong offset!");
static_assert(offsetof(UShowdownEventTileInfo_C, CommonBorder_Score) == 0x000758, "Member 'UShowdownEventTileInfo_C::CommonBorder_Score' has a wrong offset!");
static_assert(offsetof(UShowdownEventTileInfo_C, CommonTextBlock_pts) == 0x000760, "Member 'UShowdownEventTileInfo_C::CommonTextBlock_pts' has a wrong offset!");
static_assert(offsetof(UShowdownEventTileInfo_C, CommonWidgetSwitcher_EventPinState) == 0x000768, "Member 'UShowdownEventTileInfo_C::CommonWidgetSwitcher_EventPinState' has a wrong offset!");
static_assert(offsetof(UShowdownEventTileInfo_C, CommonWidgetSwitcher_TimeFormat) == 0x000770, "Member 'UShowdownEventTileInfo_C::CommonWidgetSwitcher_TimeFormat' has a wrong offset!");
static_assert(offsetof(UShowdownEventTileInfo_C, CommonWidgetSwitcher_TimeFormatTitle) == 0x000778, "Member 'UShowdownEventTileInfo_C::CommonWidgetSwitcher_TimeFormatTitle' has a wrong offset!");
static_assert(offsetof(UShowdownEventTileInfo_C, Content_Score) == 0x000780, "Member 'UShowdownEventTileInfo_C::Content_Score' has a wrong offset!");
static_assert(offsetof(UShowdownEventTileInfo_C, DateText) == 0x000788, "Member 'UShowdownEventTileInfo_C::DateText' has a wrong offset!");
static_assert(offsetof(UShowdownEventTileInfo_C, Image_Lock) == 0x000790, "Member 'UShowdownEventTileInfo_C::Image_Lock' has a wrong offset!");
static_assert(offsetof(UShowdownEventTileInfo_C, Image_Socket) == 0x000798, "Member 'UShowdownEventTileInfo_C::Image_Socket' has a wrong offset!");
static_assert(offsetof(UShowdownEventTileInfo_C, ScaleBoxPin) == 0x0007A0, "Member 'UShowdownEventTileInfo_C::ScaleBoxPin' has a wrong offset!");
static_assert(offsetof(UShowdownEventTileInfo_C, ScoreValue) == 0x0007A8, "Member 'UShowdownEventTileInfo_C::ScoreValue' has a wrong offset!");
static_assert(offsetof(UShowdownEventTileInfo_C, ShowdownPin) == 0x0007B0, "Member 'UShowdownEventTileInfo_C::ShowdownPin' has a wrong offset!");
static_assert(offsetof(UShowdownEventTileInfo_C, Switcher_EventWindowUnlockState) == 0x0007B8, "Member 'UShowdownEventTileInfo_C::Switcher_EventWindowUnlockState' has a wrong offset!");
static_assert(offsetof(UShowdownEventTileInfo_C, TimeDescriptionText) == 0x0007C0, "Member 'UShowdownEventTileInfo_C::TimeDescriptionText' has a wrong offset!");
static_assert(offsetof(UShowdownEventTileInfo_C, TimeDescriptionTextRelative) == 0x0007C8, "Member 'UShowdownEventTileInfo_C::TimeDescriptionTextRelative' has a wrong offset!");
static_assert(offsetof(UShowdownEventTileInfo_C, SetEventState) == 0x0007D0, "Member 'UShowdownEventTileInfo_C::SetEventState' has a wrong offset!");
static_assert(offsetof(UShowdownEventTileInfo_C, isEnded) == 0x0007E0, "Member 'UShowdownEventTileInfo_C::isEnded' has a wrong offset!");
static_assert(offsetof(UShowdownEventTileInfo_C, isPin) == 0x0007E1, "Member 'UShowdownEventTileInfo_C::isPin' has a wrong offset!");
static_assert(offsetof(UShowdownEventTileInfo_C, SetDisplayInfo) == 0x0007E8, "Member 'UShowdownEventTileInfo_C::SetDisplayInfo' has a wrong offset!");
static_assert(offsetof(UShowdownEventTileInfo_C, TextFontMaterial) == 0x0007F8, "Member 'UShowdownEventTileInfo_C::TextFontMaterial' has a wrong offset!");
static_assert(offsetof(UShowdownEventTileInfo_C, PointFontMaterial) == 0x000800, "Member 'UShowdownEventTileInfo_C::PointFontMaterial' has a wrong offset!");
static_assert(offsetof(UShowdownEventTileInfo_C, MultiRoundSession) == 0x000808, "Member 'UShowdownEventTileInfo_C::MultiRoundSession' has a wrong offset!");
