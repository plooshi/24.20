...
static_assert(sizeof(GeometryCollectionActor_RaycastSingle) == 0x000118, "Wrong size on GeometryCollectionActor_RaycastSingle");
...
static_assert(offsetof(GeometryCollectionActor_RaycastSingle, ReturnValue) == 0x000110, "Member 'GeometryCollectionActor_RaycastSingle::ReturnValue' has a wrong offset!");
