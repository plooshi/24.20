...
void APlayerPawn_Athena_C::GoToHUBIslandIfOutOfBounds()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PlayerPawn_Athena_C", "GoToHUBIslandIfOutOfBounds");
...
// Parameters:
// struct FRotator                         PlayerAimRotation_0                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
