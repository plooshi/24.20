...
static_assert(offsetof(SquadMemberTile_C_ExecuteUbergraph_SquadMemberTile, K2Node_Event_bIsInFrontend) == 0x0000F8, "Member 'SquadMemberTile_C_ExecuteUbergraph_SquadMemberTile::K2Node_Event_bIsInFrontend' has a wrong offset!");
static_assert(offsetof(SquadMemberTile_C_ExecuteUbergraph_SquadMemberTile, CallFunc_IsCurrentMemberInFrontend_ReturnValue) == 0x0000F9, "Member 'SquadMemberTile_C_ExecuteUbergraph_SquadMemberTile::CallFunc_IsCurrentMemberInFrontend_ReturnValue' has a wrong offset!");
