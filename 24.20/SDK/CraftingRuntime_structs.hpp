...
public:
	...
	float                                         PausedCraftingTime;                                // 0x0008(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FCraftingObjectRepStateData) == 0x000004, "Wrong alignment on FCraftingObjectRepStateData");
static_assert(sizeof(FCraftingObjectRepStateData) == 0x00000C, "Wrong size on FCraftingObjectRepStateData");
...
static_assert(offsetof(FCraftingObjectRepStateData, PausedCraftingTime) == 0x000008, "Member 'FCraftingObjectRepStateData::PausedCraftingTime' has a wrong offset!");
...
public:
	...
	float                                         OverrideCraftingTime;                              // 0x0080(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_84[0x4];                                       // 0x0084(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FCraftingFormula) == 0x000008, "Wrong alignment on FCraftingFormula");
static_assert(sizeof(FCraftingFormula) == 0x000088, "Wrong size on FCraftingFormula");
...
static_assert(offsetof(FCraftingFormula, CategoryTag) == 0x000028, "Member 'FCraftingFormula::CategoryTag' has a wrong offset!");
static_assert(offsetof(FCraftingFormula, RequiredIngredients) == 0x000030, "Member 'FCraftingFormula::RequiredIngredients' has a wrong offset!");
static_assert(offsetof(FCraftingFormula, ResultLootTierKey) == 0x000040, "Member 'FCraftingFormula::ResultLootTierKey' has a wrong offset!");
static_assert(offsetof(FCraftingFormula, WhileCraftingAbility) == 0x000048, "Member 'FCraftingFormula::WhileCraftingAbility' has a wrong offset!");
static_assert(offsetof(FCraftingFormula, UpgradeRules) == 0x000070, "Member 'FCraftingFormula::UpgradeRules' has a wrong offset!");
static_assert(offsetof(FCraftingFormula, OverrideCraftingTime) == 0x000080, "Member 'FCraftingFormula::OverrideCraftingTime' has a wrong offset!");
