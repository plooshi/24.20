...
public:
	...
	TArray<struct FPhysicsLogAnalyticsStruct>     PhysicsLogData;                                    // 0x0298(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance)
...
static_assert(sizeof(AB_PhysicsTree_Reporter_C) == 0x0002A8, "Wrong size on AB_PhysicsTree_Reporter_C");
static_assert(offsetof(AB_PhysicsTree_Reporter_C, UberGraphFrame) == 0x000288, "Member 'AB_PhysicsTree_Reporter_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AB_PhysicsTree_Reporter_C, Scene) == 0x000290, "Member 'AB_PhysicsTree_Reporter_C::Scene' has a wrong offset!");
static_assert(offsetof(AB_PhysicsTree_Reporter_C, PhysicsLogData) == 0x000298, "Member 'AB_PhysicsTree_Reporter_C::PhysicsLogData' has a wrong offset!");
