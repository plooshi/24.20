...
static_assert(sizeof(AnimNotify_Player_HandSplash_R_C_Received_Notify) == 0x000070, "Wrong size on AnimNotify_Player_HandSplash_R_C_Received_Notify");
...
static_assert(offsetof(AnimNotify_Player_HandSplash_R_C_Received_Notify, K2Node_DynamicCast_AsFort_Player_Pawn_Athena) == 0x000048, "Member 'AnimNotify_Player_HandSplash_R_C_Received_Notify::K2Node_DynamicCast_AsFort_Player_Pawn_Athena' has a wrong offset!");
static_assert(offsetof(AnimNotify_Player_HandSplash_R_C_Received_Notify, K2Node_DynamicCast_bSuccess) == 0x000050, "Member 'AnimNotify_Player_HandSplash_R_C_Received_Notify::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(AnimNotify_Player_HandSplash_R_C_Received_Notify, CallFunc_GetActivePlayerHandSplashInWaterComponent_ReturnValue) == 0x000058, "Member 'AnimNotify_Player_HandSplash_R_C_Received_Notify::CallFunc_GetActivePlayerHandSplashInWaterComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(AnimNotify_Player_HandSplash_R_C_Received_Notify, K2Node_DynamicCast_AsNiagara_Particle_System_Component) == 0x000060, "Member 'AnimNotify_Player_HandSplash_R_C_Received_Notify::K2Node_DynamicCast_AsNiagara_Particle_System_Component' has a wrong offset!");
static_assert(offsetof(AnimNotify_Player_HandSplash_R_C_Received_Notify, K2Node_DynamicCast_bSuccess_1) == 0x000068, "Member 'AnimNotify_Player_HandSplash_R_C_Received_Notify::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
