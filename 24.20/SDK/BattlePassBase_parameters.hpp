...
static_assert(offsetof(BattlePassLandingPageButton_OnSetTileImageMaterial, Material) == 0x000000, "Member 'BattlePassLandingPageButton_OnSetTileImageMaterial::Material' has a wrong offset!");
...
static_assert(offsetof(FortBattlePassDynamicIcon_OnBattlePassInfoUpdated, bOwnsBattlePass) == 0x000000, "Member 'FortBattlePassDynamicIcon_OnBattlePassInfoUpdated::bOwnsBattlePass' has a wrong offset!");
...
static_assert(sizeof(FortBattlePassPurchaseResourcesWidget_OnUpdatePageUnlockText) == 0x000018, "Wrong size on FortBattlePassPurchaseResourcesWidget_OnUpdatePageUnlockText");
static_assert(offsetof(FortBattlePassPurchaseResourcesWidget_OnUpdatePageUnlockText, PageUnlockText) == 0x000000, "Member 'FortBattlePassPurchaseResourcesWidget_OnUpdatePageUnlockText::PageUnlockText' has a wrong offset!");
...
static_assert(offsetof(FortBattlePassRewardGridHeader_OnPageLocked, IsTimeLocked) == 0x000008, "Member 'FortBattlePassRewardGridHeader_OnPageLocked::IsTimeLocked' has a wrong offset!");
static_assert(offsetof(FortBattlePassRewardGridHeader_OnPageLocked, TimeRemaining) == 0x000010, "Member 'FortBattlePassRewardGridHeader_OnPageLocked::TimeRemaining' has a wrong offset!");
...
static_assert(offsetof(FortBattlePassTileBase_AreAnyGrantedItemsEquipped, ReturnValue) == 0x000000, "Member 'FortBattlePassTileBase_AreAnyGrantedItemsEquipped::ReturnValue' has a wrong offset!");
