...
static_assert(alignof(UVerseExperimental_date_time_ticks) == 0x000008, "Wrong alignment on UVerseExperimental_date_time_ticks");
static_assert(sizeof(UVerseExperimental_date_time_ticks) == 0x000070, "Wrong size on UVerseExperimental_date_time_ticks");
static_assert(offsetof(UVerseExperimental_date_time_ticks, __verse_0x8DE5F121_NanosecondsPerTick) == 0x000028, "Member 'UVerseExperimental_date_time_ticks::__verse_0x8DE5F121_NanosecondsPerTick' has a wrong offset!");
static_assert(offsetof(UVerseExperimental_date_time_ticks, __verse_0x358147B9_TicksPerDay) == 0x000030, "Member 'UVerseExperimental_date_time_ticks::__verse_0x358147B9_TicksPerDay' has a wrong offset!");
static_assert(offsetof(UVerseExperimental_date_time_ticks, __verse_0x5C0949D3_TicksPerHour) == 0x000038, "Member 'UVerseExperimental_date_time_ticks::__verse_0x5C0949D3_TicksPerHour' has a wrong offset!");
static_assert(offsetof(UVerseExperimental_date_time_ticks, __verse_0x59DFB831_TicksPerMicrosecond) == 0x000040, "Member 'UVerseExperimental_date_time_ticks::__verse_0x59DFB831_TicksPerMicrosecond' has a wrong offset!");
static_assert(offsetof(UVerseExperimental_date_time_ticks, __verse_0xD20E16AF_TicksPerMillisecond) == 0x000048, "Member 'UVerseExperimental_date_time_ticks::__verse_0xD20E16AF_TicksPerMillisecond' has a wrong offset!");
static_assert(offsetof(UVerseExperimental_date_time_ticks, __verse_0x4420B794_TicksPerMinute) == 0x000050, "Member 'UVerseExperimental_date_time_ticks::__verse_0x4420B794_TicksPerMinute' has a wrong offset!");
static_assert(offsetof(UVerseExperimental_date_time_ticks, __verse_0x3E0178E0_TicksPerSecond) == 0x000058, "Member 'UVerseExperimental_date_time_ticks::__verse_0x3E0178E0_TicksPerSecond' has a wrong offset!");
static_assert(offsetof(UVerseExperimental_date_time_ticks, __verse_0xA7911900_TicksPerWeek) == 0x000060, "Member 'UVerseExperimental_date_time_ticks::__verse_0xA7911900_TicksPerWeek' has a wrong offset!");
static_assert(offsetof(UVerseExperimental_date_time_ticks, __verse_0xE371C089_TicksPerYear) == 0x000068, "Member 'UVerseExperimental_date_time_ticks::__verse_0xE371C089_TicksPerYear' has a wrong offset!");
