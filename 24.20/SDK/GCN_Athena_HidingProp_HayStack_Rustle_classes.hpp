...
static_assert(alignof(UGCN_Athena_HidingProp_HayStack_Rustle_C) == 0x000008, "Wrong alignment on UGCN_Athena_HidingProp_HayStack_Rustle_C");
static_assert(sizeof(UGCN_Athena_HidingProp_HayStack_Rustle_C) == 0x000210, "Wrong size on UGCN_Athena_HidingProp_HayStack_Rustle_C");
