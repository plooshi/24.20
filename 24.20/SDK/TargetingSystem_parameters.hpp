...
static_assert(offsetof(TargetingSubsystem_StartAsyncTargetingRequest, ReturnValue) == 0x00004C, "Member 'TargetingSubsystem_StartAsyncTargetingRequest::ReturnValue' has a wrong offset!");
