...
static_assert(alignof(UGCN_Athena_GenericHeldObject_HitWorld_C) == 0x000008, "Wrong alignment on UGCN_Athena_GenericHeldObject_HitWorld_C");
static_assert(sizeof(UGCN_Athena_GenericHeldObject_HitWorld_C) == 0x000218, "Wrong size on UGCN_Athena_GenericHeldObject_HitWorld_C");
static_assert(offsetof(UGCN_Athena_GenericHeldObject_HitWorld_C, Sound_to_Play) == 0x000210, "Member 'UGCN_Athena_GenericHeldObject_HitWorld_C::Sound_to_Play' has a wrong offset!");
