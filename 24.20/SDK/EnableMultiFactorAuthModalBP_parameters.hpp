...
public:
	...
	class UIconTextButton_C*                      K2Node_DynamicCast_AsIcon_Text_Button;             // 0x0068(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(EnableMultiFactorAuthModalBP_C_ExecuteUbergraph_EnableMultiFactorAuthModalBP, CallFunc_Delay_Duration_ImplicitCast) == 0x000094, "Member 'EnableMultiFactorAuthModalBP_C_ExecuteUbergraph_EnableMultiFactorAuthModalBP::CallFunc_Delay_Duration_ImplicitCast' has a wrong offset!");
...
static_assert(sizeof(EnableMultiFactorAuthModalBP_C_ScaleTitleForCulture) == 0x000018, "Wrong size on EnableMultiFactorAuthModalBP_C_ScaleTitleForCulture");
...
static_assert(offsetof(EnableMultiFactorAuthModalBP_C_ScaleTitleForCulture, MaxCharCountForScale) == 0x000008, "Member 'EnableMultiFactorAuthModalBP_C_ScaleTitleForCulture::MaxCharCountForScale' has a wrong offset!");
static_assert(offsetof(EnableMultiFactorAuthModalBP_C_ScaleTitleForCulture, StartScaleAfterCharCount) == 0x000010, "Member 'EnableMultiFactorAuthModalBP_C_ScaleTitleForCulture::StartScaleAfterCharCount' has a wrong offset!");
