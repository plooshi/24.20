...
{
public:
	class USoundBase*                             Throw_Sound;                                       // 0x0210(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UGCN_Athena_GenericHeldObject_Throw_C) == 0x000218, "Wrong size on UGCN_Athena_GenericHeldObject_Throw_C");
static_assert(offsetof(UGCN_Athena_GenericHeldObject_Throw_C, Throw_Sound) == 0x000210, "Member 'UGCN_Athena_GenericHeldObject_Throw_C::Throw_Sound' has a wrong offset!");
